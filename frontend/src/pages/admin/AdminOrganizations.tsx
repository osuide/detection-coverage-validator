                ...
                <tbody>
                  {organizations.map((org) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <span className={`px-2 py-1 rounded text-xs font-medium ${getTierColor(org.tier)}`}>
                          {org.tier}
                        </span>
                      </td>
            ...
            <div className="w-1/2 bg-gray-800 rounded-xl border border-gray-700 p-6">
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center justify-between p-3 bg-gray-700/50 rounded-lg">
                  <span className={`px-2 py-1 rounded text-sm font-medium ${getTierColor(selectedOrg.tier)}`}>
                    {selectedOrg.tier}
                  </span>
