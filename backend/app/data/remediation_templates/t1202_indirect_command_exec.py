...
resource "aws_sns_topic_policy" "wsl_abuse_alerts" {
  ...
  policy = jsonencode({
    ...
    Condition = {
        ...
        # Azure Strategy: Indirect Command Execution
        DetectionStrategy(
            strategy_id="t1202-azure",
            name="Azure Indirect Command Execution Detection",
            description=(
                "Azure detection for Indirect Command Execution. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Indirect Command Execution
// MITRE ATT&CK: T1202
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Indirect Command Execution
# MITRE ATT&CK: T1202
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "indirect-command-execution-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Indirect Command Execution
// MITRE ATT&CK: T1202
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Indirect Command Execution (T1202) activity in Azure environment"
  display_name = "Indirect Command Execution Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1202"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Indirect Command Execution Detected",
                alert_description_template=(
                    "Indirect Command Execution activity detected. "
