...
resource "google_monitoring_alert_policy" "xsl_processing" {
  ...
  documentation {
    ...
    mime_type = "text/markdown"
        ...
        # Azure Strategy: XSL Script Processing
        DetectionStrategy(
            strategy_id="t1220-azure",
            name="Azure XSL Script Processing Detection",
            description=(
                "Azure detection for XSL Script Processing. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: XSL Script Processing
// MITRE ATT&CK: T1220
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for XSL Script Processing
# MITRE ATT&CK: T1220
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "xsl-script-processing-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: XSL Script Processing
// MITRE ATT&CK: T1220
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects XSL Script Processing (T1220) activity in Azure environment"
  display_name = "XSL Script Processing Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1220"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: XSL Script Processing Detected",
                alert_description_template=(
                    "XSL Script Processing activity detected. "
