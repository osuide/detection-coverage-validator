...
data "aws_iam_policy_document" "eventbridge_dlq_policy" {
  statement {
    ...
    condition {
      ...
      values   = [aws_cloudwatch_event_rule.guardduty_mod.arn]
    }
  }
}
...
# SQS Queue Policy for EventBridge DLQ (CRITICAL)
# Without this, EventBridge cannot send failed events to the DLQ
data "aws_iam_policy_document" "securityhub_dlq_policy" {
  statement {
    sid     = "AllowEventBridgeToSendToDLQ"
    effect  = "Allow"
    actions = ["sqs:SendMessage"]
    ...
    condition {
      test     = "ArnEquals"
      variable = "aws:SourceArn"
      values   = [aws_cloudwatch_event_rule.securityhub_mod.arn]
    }
  }
}
...
resource "aws_sqs_queue_policy" "securityhub_dlq" {
  queue_url = aws_sqs_queue.dlq.url
  policy    = data.aws_iam_policy_document.securityhub_dlq_policy.json
}
...
# SQS Queue Policy for EventBridge DLQ (CRITICAL)
# Without this, EventBridge cannot send failed events to the DLQ
data "aws_iam_policy_document" "config_dlq_policy" {
  statement {
    sid     = "AllowEventBridgeToSendToDLQ"
    effect  = "Allow"
    actions = ["sqs:SendMessage"]
    ...
    condition {
      test     = "ArnEquals"
      variable = "aws:SourceArn"
      values   = [aws_cloudwatch_event_rule.config_compliance.arn]
    }
  }
}

resource "aws_sqs_queue_policy" "config_dlq" {
  queue_url = aws_sqs_queue.dlq.url
  policy    = data.aws_iam_policy_document.config_dlq_policy.json
}
  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Impair Defences
        DetectionStrategy(
            strategy_id="t1562-azure",
            name="Azure Impair Defences Detection",
            description=(
                "Monitor security control modifications. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Impair Defences Detection
// Technique: T1562
AzureActivity
| where TimeGenerated > ago(24h)
| where OperationNameValue contains "Microsoft.Insights/diagnosticSettings/delete" or OperationNameValue contains "Microsoft.Security/"
...
| order by TimeGenerated desc""",
                ...
                azure_terraform_template="""# Azure Detection for Impair Defences
# MITRE ATT&CK: T1562
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "impair-defences-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
...
| order by TimeGenerated desc
  ...
  description = "Detects Impair Defences (T1562) activity in Azure environment"
  display_name = "Impair Defences Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Impair Defences Detected",
                alert_description_template=(
                    "Impair Defences activity detected. "
