...
resource "google_pubsub_subscription" "chronicle_findings_sub" {
  ...
  push_config {
    push_endpoint = "https://example.com/chronicle-webhook"  # Replace with your endpoint
        ...
        # Azure Strategy: Template Injection
        DetectionStrategy(
            strategy_id="t1221-azure",
            name="Azure Template Injection Detection",
            description=(
                "Azure detection for Template Injection. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Template Injection
// MITRE ATT&CK: T1221
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Template Injection
# MITRE ATT&CK: T1221
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Template Injection
// MITRE ATT&CK: T1221
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Template Injection (T1221) activity in Azure environment"
  display_name = "Template Injection Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1221"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Template Injection Detected",
                alert_description_template=(
                    "Template Injection activity detected. "
