  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Non-Standard Port
        DetectionStrategy(
            strategy_id="t1571-azure",
            name="Azure Non-Standard Port Detection",
            description=(
                "Azure detection for Non-Standard Port. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Non-Standard Port
// MITRE ATT&CK: T1571
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Non-Standard Port
# MITRE ATT&CK: T1571
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "non-standard-port-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Non-Standard Port
// MITRE ATT&CK: T1571
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Non-Standard Port (T1571) activity in Azure environment"
  display_name = "Non-Standard Port Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Non-Standard Port Detected",
                alert_description_template=(
                    "Non-Standard Port activity detected. "
