...
data "aws_iam_policy_document" "eventbridge_dlq_policy" {
  statement {
    ...
    condition {
      ...
      values   = [aws_cloudwatch_event_rule.fsx_access.arn]
    }
  }
}
  ...
  alert_strategy {
    notification_rate_limit {
      period = "3600s"
        ...
        # Azure Strategy: Data from Network Shared Drive
        DetectionStrategy(
            strategy_id="t1039-azure",
            name="Azure Data from Network Shared Drive Detection",
            description=(
                "Azure detection for Data from Network Shared Drive. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Data from Network Shared Drive Detection
// Technique: T1039
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Data from Network Shared Drive
# MITRE ATT&CK: T1039
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "data-from-network-shared-drive-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "data-from-network-shared-drive-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Data from Network Shared Drive Detection
// Technique: T1039
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects Data from Network Shared Drive (T1039) activity in Azure environment"
  display_name = "Data from Network Shared Drive Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1039"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Data from Network Shared Drive Detected",
                alert_description_template=(
                    "Data from Network Shared Drive activity detected. "
