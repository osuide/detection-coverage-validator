...
TEMPLATE = RemediationTemplate(
    ...
    threat_context=ThreatContext(
        ...
        known_threat_actors=[
            "APT28", "APT29", "APT32", "APT33", "APT38", "APT39", "APT41",
            "APT1", "APT42", "Lazarus Group", "Scattered Spider", "LAPSUS$",
            "Aquatic Panda", "BackdoorDiplomacy", "Turla", "FIN7", "FIN10",
            "Wizard Spider", "TA505", "Ember Bear", "UNC3886"
        ],
        recent_campaigns=[
            Campaign(
