...
resource "aws_cloudwatch_metric_alarm" "cert_anomaly" {
  ...
  alarm_actions       = [aws_sns_topic.alerts.arn]
        ...
        # Azure Strategy: Obtain Capabilities
        DetectionStrategy(
            strategy_id="t1588-azure",
            name="Azure Obtain Capabilities Detection",
            description=(
                "Azure detection for Obtain Capabilities. "
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Obtain Capabilities Detected",
                alert_description_template=(
                    "Obtain Capabilities activity detected. "
