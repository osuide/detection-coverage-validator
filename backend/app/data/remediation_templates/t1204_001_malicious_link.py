...
resource "google_monitoring_alert_policy" "safe_browsing_alert" {
  ...
  documentation {
    ...
    mime_type = "text/markdown"
        ...
        # Azure Strategy: User Execution: Malicious Link
        DetectionStrategy(
            strategy_id="t1204001-azure",
            name="Azure User Execution: Malicious Link Detection",
            description=(
                "Azure detection for User Execution: Malicious Link. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: User Execution: Malicious Link
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for User Execution: Malicious Link
# MITRE ATT&CK: T1204.001
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "user-execution--malicious-link-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "user-execution--malicious-link-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: User Execution: Malicious Link
// MITRE ATT&CK: T1204.001
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects User Execution: Malicious Link (T1204.001) activity in Azure environment"
  display_name = "User Execution: Malicious Link Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1204.001"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: User Execution: Malicious Link Detected",
                alert_description_template=(
                    "User Execution: Malicious Link activity detected. "
