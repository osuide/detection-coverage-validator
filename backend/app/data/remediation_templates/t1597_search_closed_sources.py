...
resource "aws_sns_topic_policy" "allow_eventbridge" {
  ...
  policy = jsonencode({
    ...
    Condition = {
        ...
        # Azure Strategy: Search Closed Sources
        DetectionStrategy(
            strategy_id="t1597-azure",
            name="Azure Search Closed Sources Detection",
            description=(
                "Azure detection for Search Closed Sources. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Search Closed Sources Detection
// Technique: T1597
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Search Closed Sources
# MITRE ATT&CK: T1597
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "search-closed-sources-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "search-closed-sources-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Search Closed Sources Detection
// Technique: T1597
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects Search Closed Sources (T1597) activity in Azure environment"
  display_name = "Search Closed Sources Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1597"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Search Closed Sources Detected",
                alert_description_template=(
                    "Search Closed Sources activity detected. "
