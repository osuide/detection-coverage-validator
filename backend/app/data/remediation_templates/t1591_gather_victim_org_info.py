  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Gather Victim Org Information
        DetectionStrategy(
            strategy_id="t1591-azure",
            name="Azure Gather Victim Org Information Detection",
            description=(
                "Azure detection for Gather Victim Org Information. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Gather Victim Org Information Detection
// Technique: T1591
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Gather Victim Org Information
# MITRE ATT&CK: T1591
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "gather-victim-org-information-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "gather-victim-org-information-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Gather Victim Org Information Detection
// Technique: T1591
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects Gather Victim Org Information (T1591) activity in Azure environment"
  display_name = "Gather Victim Org Information Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Gather Victim Org Information Detected",
                alert_description_template=(
                    "Gather Victim Org Information activity detected. "
