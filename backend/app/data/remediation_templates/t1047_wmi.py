...
resource "aws_cloudwatch_log_metric_filter" "malicious_wmi_namespace" {
  ...
  metric_transformation {
    ...
    value     = "1"
        ...
        # Azure Strategy: Windows Management Instrumentation
        DetectionStrategy(
            strategy_id="t1047-azure",
            name="Azure Windows Management Instrumentation Detection",
            description=(
                "Azure detection for Windows Management Instrumentation. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Windows Management Instrumentation
// MITRE ATT&CK: T1047
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Windows Management Instrumentation
# MITRE ATT&CK: T1047
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "windows-management-instrumentation-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "windows-management-instrumentation-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Windows Management Instrumentation
// MITRE ATT&CK: T1047
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Windows Management Instrumentation (T1047) activity in Azure environment"
  display_name = "Windows Management Instrumentation Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Windows Management Instrumentation Detected",
                alert_description_template=(
                    "Windows Management Instrumentation activity detected. "
