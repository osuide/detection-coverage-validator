...
resource "aws_cloudwatch_metric_alarm" "correlated_access" {
  ...
  alarm_actions       = [aws_sns_topic.alerts.arn]
        ...
        # Azure Strategy: Account Manipulation: SSH Authorized Keys
        DetectionStrategy(
            strategy_id="t1098004-azure",
            name="Azure Account Manipulation: SSH Authorized Keys Detection",
            description=(
                "Azure detection for Account Manipulation: SSH Authorized Keys. "
...
resource "azurerm_monitor_action_group" "defender_alerts" {
  name                = "defender-t1098-004-alerts"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Account Manipulation: SSH Authorized Keys Detected",
                alert_description_template=(
                    "Account Manipulation: SSH Authorized Keys activity detected. "
