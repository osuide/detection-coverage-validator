...
resource "aws_sns_topic_policy" "allow_cloudwatch" {
  arn = aws_sns_topic.c2_exfil_alerts.arn
  policy = jsonencode({
    Version = "2012-10-17"
    Statement = [{
      Sid       = "AllowCloudWatchAlarms"
      ...
      Action    = "sns:Publish"
      Resource  = aws_sns_topic.c2_exfil_alerts.arn
      Condition = {
        StringEquals = {
...
resource "google_monitoring_alert_policy" "data_access_alert" {
  ...
  documentation {
    ...
    mime_type = "text/markdown"
        ...
        # Azure Strategy: Exfiltration Over C2 Channel
        DetectionStrategy(
            strategy_id="t1041-azure",
            name="Azure Exfiltration Over C2 Channel Detection",
            description=(
                "Azure detection for Exfiltration Over C2 Channel. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Exfiltration Over C2 Channel Detection
// Technique: T1041
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Exfiltration Over C2 Channel
# MITRE ATT&CK: T1041
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "exfiltration-over-c2-channel-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  ...
  criteria {
    query = <<-QUERY
// Exfiltration Over C2 Channel Detection
// Technique: T1041
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects Exfiltration Over C2 Channel (T1041) activity in Azure environment"
  display_name = "Exfiltration Over C2 Channel Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Exfiltration Over C2 Channel Detected",
                alert_description_template=(
                    "Exfiltration Over C2 Channel activity detected. "
