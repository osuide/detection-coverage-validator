  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Active Scanning
        DetectionStrategy(
            strategy_id="t1595-azure",
            name="Azure Active Scanning Detection",
            description=(
                "Azure detection for Active Scanning. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Active Scanning Detection
// Technique: T1595
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Active Scanning
# MITRE ATT&CK: T1595
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "active-scanning-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
...
| order by OperationCount desc
  ...
  description = "Detects Active Scanning (T1595) activity in Azure environment"
  display_name = "Active Scanning Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Active Scanning Detected",
