        ...
        Statement:
          - Effect: Allow
            ...
            Condition:
              ...
              ArnEquals:
                aws:SourceArn: !GetAtt DDNSDetectionRule.Arn""",
          ...
          - Effect: Allow
            ...
            Condition:
              StringEquals:
                AWS:SourceAccount: !Ref AWS::AccountId
              ArnEquals:
                aws:SourceArn: !GetAtt MaliciousDomainRule.Arn""",
  ...
  event_pattern = jsonencode({
    ...
    detail = {
      type = [
        ...
        { prefix = "Trojan:EC2/DNSDataExfiltration" },
        { prefix = "Trojan:EC2/DGADomainRequest.B" }
      ]
    }
  })
}
...
resource "aws_sqs_queue_policy" "dlq_policy" {
  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Condition = {
        ArnEquals = {
          "aws:SourceArn" = aws_cloudwatch_event_rule.malicious_domain.arn
        }
      }
    }]
  })
...
# Or use google_scc_notification_config with appropriate permissions""",
        ...
        # Azure Strategy: Dynamic Resolution
        DetectionStrategy(
            strategy_id="t1568-azure",
            name="Azure Dynamic Resolution Detection",
            description=(
                "Azure detection for Dynamic Resolution. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Dynamic Resolution
// MITRE ATT&CK: T1568
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Dynamic Resolution
# MITRE ATT&CK: T1568
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "dynamic-resolution-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "dynamic-resolution-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Dynamic Resolution
// MITRE ATT&CK: T1568
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Dynamic Resolution (T1568) activity in Azure environment"
  display_name = "Dynamic Resolution Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Dynamic Resolution Detected",
                alert_description_template=(
                    "Dynamic Resolution activity detected. "
