  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Revert Cloud Instance
        DetectionStrategy(
            strategy_id="t1578004-azure",
            name="Azure Revert Cloud Instance Detection",
            description=(
                "Azure detection for Revert Cloud Instance. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Revert Cloud Instance
// MITRE ATT&CK: T1578.004
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Revert Cloud Instance
# MITRE ATT&CK: T1578.004
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "revert-cloud-instance-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "revert-cloud-instance-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Revert Cloud Instance
// MITRE ATT&CK: T1578.004
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Revert Cloud Instance (T1578.004) activity in Azure environment"
  display_name = "Revert Cloud Instance Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1578.004"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Revert Cloud Instance Detected",
                alert_description_template=(
                    "Revert Cloud Instance activity detected. "
