...
resource "aws_sqs_queue" "dlq" {
  name                      = "guardduty-tor-eventbridge-dlq"
...
resource "aws_sns_topic_policy" "guardduty_publish" {
  ...
  policy = jsonencode({
    ...
    Condition = {
        ...
        ArnEquals = {
          "aws:SourceArn" = aws_cloudwatch_event_rule.tor_findings.arn
        }
      }
    }]
  })
...
resource "google_bigquery_job" "proxy_pattern_detection" {
  ...
  query {
    ...
    use_legacy_sql = false
        ...
        # Azure Strategy: Proxy: Multi-hop Proxy
        DetectionStrategy(
            strategy_id="t1090003-azure",
            name="Azure Proxy: Multi-hop Proxy Detection",
            description=(
                "Azure detection for Proxy: Multi-hop Proxy. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Proxy: Multi-hop Proxy
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Proxy: Multi-hop Proxy
# MITRE ATT&CK: T1090.003
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Proxy: Multi-hop Proxy
// MITRE ATT&CK: T1090.003
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Proxy: Multi-hop Proxy (T1090.003) activity in Azure environment"
  display_name = "Proxy: Multi-hop Proxy Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1090.003"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Proxy: Multi-hop Proxy Detected",
                alert_description_template=(
                    "Proxy: Multi-hop Proxy activity detected. "
