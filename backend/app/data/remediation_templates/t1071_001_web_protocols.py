...
resource "aws_sns_topic_policy" "allow_events" {
  ...
  policy = jsonencode({
    ...
    Condition = {
        ...
        # Azure Strategy: Application Layer Protocol: Web Protocols
        DetectionStrategy(
            strategy_id="t1071001-azure",
            name="Azure Application Layer Protocol: Web Protocols Detection",
            description=(
                "Azure detection for Application Layer Protocol: Web Protocols. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Application Layer Protocol: Web Protocols
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Application Layer Protocol: Web Protocols
# MITRE ATT&CK: T1071.001
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "application-layer-protocol--web-protocols-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "application-layer-protocol--web-protocols-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Application Layer Protocol: Web Protocols
// MITRE ATT&CK: T1071.001
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Application Layer Protocol: Web Protocols (T1071.001) activity in Azure environment"
  display_name = "Application Layer Protocol: Web Protocols Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Application Layer Protocol: Web Protocols Detected",
                alert_description_template=(
                    "Application Layer Protocol: Web Protocols activity detected. "
