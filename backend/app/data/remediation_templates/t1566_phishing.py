  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Phishing
        DetectionStrategy(
            strategy_id="t1566-azure",
            name="Azure Phishing Detection",
            description=(
                "Azure detection for Phishing. "
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Phishing Detected",
                alert_description_template=(
