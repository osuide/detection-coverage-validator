...
resource "google_monitoring_alert_policy" "function_guardrails" {
  ...
  documentation {
    ...
    EOT
        ...
        # Azure Strategy: Execution Guardrails
        DetectionStrategy(
            strategy_id="t1480-azure",
            name="Azure Execution Guardrails Detection",
            description=(
                "Azure detection for Execution Guardrails. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Execution Guardrails
// MITRE ATT&CK: T1480
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Execution Guardrails
# MITRE ATT&CK: T1480
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "execution-guardrails-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "execution-guardrails-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Execution Guardrails
// MITRE ATT&CK: T1480
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Execution Guardrails (T1480) activity in Azure environment"
  display_name = "Execution Guardrails Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1480"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Execution Guardrails Detected",
                alert_description_template=(
                    "Execution Guardrails activity detected. "
