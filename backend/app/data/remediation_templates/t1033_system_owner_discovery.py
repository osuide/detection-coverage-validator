  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: System Owner/User Discovery
        DetectionStrategy(
            strategy_id="t1033-azure",
            name="Azure System Owner/User Discovery Detection",
            description=(
                "Azure detection for System Owner/User Discovery. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// System Owner/User Discovery Detection
// Technique: T1033
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for System Owner/User Discovery
# MITRE ATT&CK: T1033
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "system-owner-user-discovery-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "system-owner-user-discovery-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// System Owner/User Discovery Detection
// Technique: T1033
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects System Owner/User Discovery (T1033) activity in Azure environment"
  display_name = "System Owner/User Discovery Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1033"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: System Owner/User Discovery Detected",
                alert_description_template=(
                    "System Owner/User Discovery activity detected. "
