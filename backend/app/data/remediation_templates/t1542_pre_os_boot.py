...
resource "aws_sqs_queue" "dlq" {
  name                      = "ec2-boot-verification-dlq"
...
resource "aws_sqs_queue_policy" "dlq" {
  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Condition = {
        ArnEquals = { "aws:SourceArn" = aws_cloudwatch_event_rule.instance_launch.arn }
      }
    }]
  })
}
...
resource "google_pubsub_topic_iam_binding" "log_sink" {
  ...
  members = [google_logging_project_sink.instance_creation.writer_identity]
        ...
        # Azure Strategy: Pre-OS Boot
        DetectionStrategy(
            strategy_id="t1542-azure",
            name="Azure Pre-OS Boot Detection",
            description=(
                "Azure detection for Pre-OS Boot. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Pre-OS Boot
// MITRE ATT&CK: T1542
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Pre-OS Boot
# MITRE ATT&CK: T1542
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Pre-OS Boot
// MITRE ATT&CK: T1542
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Pre-OS Boot (T1542) activity in Azure environment"
  display_name = "Pre-OS Boot Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Pre-OS Boot Detected",
                alert_description_template=(
                    "Pre-OS Boot activity detected. "
