        ...
        Statement:
          - Effect: Allow
            ...
            Condition:
              ...
              ArnEquals:
                aws:SourceArn: !GetAtt EncodingToolsRule.Arn""",
...
resource "google_monitoring_alert_policy" "encoding_tools" {
  ...
  documentation {
    content = "Encoding utility execution detected. Investigate for potential encoded C2 or data preparation for exfiltration."
        ...
        # Azure Strategy: Data Encoding
        DetectionStrategy(
            strategy_id="t1132-azure",
            name="Azure Data Encoding Detection",
            description=(
                "Azure detection for Data Encoding. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Data Encoding
// MITRE ATT&CK: T1132
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Data Encoding
# MITRE ATT&CK: T1132
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Data Encoding
// MITRE ATT&CK: T1132
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Data Encoding (T1132) activity in Azure environment"
  display_name = "Data Encoding Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1132"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Data Encoding Detected",
                alert_description_template=(
                    "Data Encoding activity detected. "
