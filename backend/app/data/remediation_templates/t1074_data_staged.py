  ...
  alert_strategy {
    notification_rate_limit {
      period = "3600s"
        ...
        # Azure Strategy: Data Staged
        DetectionStrategy(
            strategy_id="t1074-azure",
            name="Azure Data Staged Detection",
            description=(
                "Azure detection for Data Staged. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Data Staged Detection
// Technique: T1074
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Data Staged
# MITRE ATT&CK: T1074
...
| order by OperationCount desc
  ...
  description = "Detects Data Staged (T1074) activity in Azure environment"
  display_name = "Data Staged Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1074"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Data Staged Detected",
                alert_description_template=(
                    "Data Staged activity detected. "
