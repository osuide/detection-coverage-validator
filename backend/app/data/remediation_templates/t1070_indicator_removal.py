          ...
          - Effect: Allow
            ...
            Condition:
              StringEquals:
                AWS:SourceAccount: !Ref AWS::AccountId
              ArnEquals:
                aws:SourceArn: !GetAtt LogDeletionRule.Arn""",
...
resource "google_monitoring_alert_policy" "history_clearing" {
  ...
  documentation {
    ...
    mime_type = "text/markdown"
        ...
        # Azure Strategy: Indicator Removal
        DetectionStrategy(
            strategy_id="t1070-azure",
            name="Azure Indicator Removal Detection",
            description=(
                "Monitor log and audit trail modifications. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Indicator Removal Detection
// Technique: T1070
AzureActivity
| where TimeGenerated > ago(24h)
| where OperationNameValue contains "Microsoft.Insights/activityLogAlerts/delete"
...
| order by TimeGenerated desc""",
                ...
                azure_terraform_template="""# Azure Detection for Indicator Removal
# MITRE ATT&CK: T1070
...
| order by TimeGenerated desc
  ...
  description = "Detects Indicator Removal (T1070) activity in Azure environment"
  display_name = "Indicator Removal Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Indicator Removal Detected",
                alert_description_template=(
                    "Indicator Removal activity detected. "
