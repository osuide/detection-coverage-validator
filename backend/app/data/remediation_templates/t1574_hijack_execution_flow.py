...
resource "google_monitoring_alert_policy" "metadata_mod" {
  ...
  documentation {
    ...
    EOT
        ...
        # Azure Strategy: Hijack Execution Flow
        DetectionStrategy(
            strategy_id="t1574-azure",
            name="Azure Hijack Execution Flow Detection",
            description=(
                "Azure detection for Hijack Execution Flow. "
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Hijack Execution Flow Detected",
                alert_description_template=(
                    "Hijack Execution Flow activity detected. "
