  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: System Information Discovery
        DetectionStrategy(
            strategy_id="t1082-azure",
            name="Azure System Information Discovery Detection",
            description=(
                "Azure detection for System Information Discovery. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// System Information Discovery Detection
// Technique: T1082
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for System Information Discovery
# MITRE ATT&CK: T1082
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "system-information-discovery-alerts"
...
| order by OperationCount desc
  ...
  description = "Detects System Information Discovery (T1082) activity in Azure environment"
  display_name = "System Information Discovery Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: System Information Discovery Detected",
