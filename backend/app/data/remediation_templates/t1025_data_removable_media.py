  ...
  alert_strategy {
    notification_rate_limit {
      period = "3600s"
        ...
        # Azure Strategy: Data from Removable Media
        DetectionStrategy(
            strategy_id="t1025-azure",
            name="Azure Data from Removable Media Detection",
            description=(
                "Azure detection for Data from Removable Media. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Data from Removable Media Detection
// Technique: T1025
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Data from Removable Media
# MITRE ATT&CK: T1025
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "data-from-removable-media-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "data-from-removable-media-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Data from Removable Media Detection
// Technique: T1025
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects Data from Removable Media (T1025) activity in Azure environment"
  display_name = "Data from Removable Media Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1025"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Data from Removable Media Detected",
                alert_description_template=(
                    "Data from Removable Media activity detected. "
