        ...
        Statement:
          - Effect: Allow
            ...
            Condition:
              ...
              ArnEquals:
                aws:SourceArn: !GetAtt ProxyDeploymentRule.Arn""",
...
resource "aws_sqs_queue" "dlq" {
  name                      = "proxy-deployment-eventbridge-dlq"
...
resource "aws_sns_topic_policy" "allow_events" {
  ...
  policy = jsonencode({
    ...
    Condition = {
        ...
        ArnEquals = {
          "aws:SourceArn" = aws_cloudwatch_event_rule.proxy_deployment.arn
        }
      }
    }]
  })
...
# Consider using Lambda for automated analysis of Host header mismatches""",
        ...
        # Azure Strategy: Proxy
        DetectionStrategy(
            strategy_id="t1090-azure",
            name="Azure Proxy Detection",
            description=(
                "Azure detection for Proxy. "
...
| project
  ...
  description = "Detects Proxy (T1090) activity in Azure environment"
  display_name = "Proxy Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Proxy Detected",
                alert_description_template=(
                    "Proxy activity detected. "
