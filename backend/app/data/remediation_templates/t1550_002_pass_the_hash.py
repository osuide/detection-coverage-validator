...
resource "google_monitoring_alert_policy" "ntlm_alert" {
  ...
  documentation {
    ...
    EOT
        ...
        # Azure Strategy: Use Alternate Authentication Material: Pass the Hash
        DetectionStrategy(
            strategy_id="t1550002-azure",
            name="Azure Use Alternate Authentication Material: Pass the Hash Detection",
            description=(
                "Azure detection for Use Alternate Authentication Material: Pass the Hash. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Use Alternate Authentication Material: Pass the Hash
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Use Alternate Authentication Material: Pass the Hash
# MITRE ATT&CK: T1550.002
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "use-alternate-authentication-material--pass-the-ha-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "use-alternate-authentication-material--pass-the-ha-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Use Alternate Authentication Material: Pass the Hash
// MITRE ATT&CK: T1550.002
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Use Alternate Authentication Material: Pass the Hash (T1550.002) activity in Azure environment"
  display_name = "Use Alternate Authentication Material: Pass the Hash Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Use Alternate Authentication Material: Pass the Hash Detected",
                alert_description_template=(
                    "Use Alternate Authentication Material: Pass the Hash activity detected. "
