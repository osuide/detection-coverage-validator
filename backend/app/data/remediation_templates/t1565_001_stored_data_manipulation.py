...
resource "google_storage_bucket_iam_member" "audit_writer" {
  ...
  member = google_logging_project_sink.database_audit.writer_identity
        ...
        # Azure Strategy: Data Manipulation: Stored Data Manipulation
        DetectionStrategy(
            strategy_id="t1565001-azure",
            name="Azure Data Manipulation: Stored Data Manipulation Detection",
            description=(
                "Azure detection for Data Manipulation: Stored Data Manipulation. "
...
resource "azurerm_monitor_action_group" "defender_alerts" {
  name                = "defender-t1565-001-alerts"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Data Manipulation: Stored Data Manipulation Detected",
                alert_description_template=(
                    "Data Manipulation: Stored Data Manipulation activity detected. "
