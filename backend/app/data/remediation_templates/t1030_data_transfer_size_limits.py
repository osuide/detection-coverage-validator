...
resource "aws_sns_topic_policy" "allow_cloudwatch" {
  arn = aws_sns_topic.chunked_upload_alerts.arn
  policy = jsonencode({
    Version = "2012-10-17"
    Statement = [{
      Sid       = "AllowCloudWatchAlarms"
      ...
      Action    = "sns:Publish"
      Resource  = aws_sns_topic.chunked_upload_alerts.arn
      Condition = {
        StringEquals = {
...
resource "aws_sns_topic_policy" "allow_cloudwatch" {
  arn = aws_sns_topic.network_chunk_alerts.arn
  policy = jsonencode({
    Version = "2012-10-17"
    Statement = [{
      Sid       = "AllowCloudWatchAlarms"
      ...
      Principal = { Service = "cloudwatch.amazonaws.com" }
      Action    = "sns:Publish"
      Resource  = aws_sns_topic.network_chunk_alerts.arn
      Condition = {
        StringEquals = {
          "AWS:SourceAccount" = data.aws_caller_identity.current.account_id
        }
      ...
      Targets:
        - Id: Alert
          ...
          InputTransformer:
            ...
            InputTemplate: |
              "Lambda Scheduled Invocation (T1030)
              time=<time> account=<account> region=<region>
              function=<functionName> user=<user>
              Action: Verify scheduled function legitimacy"

  # Step 3: Dead letter queue
  DeadLetterQueue:
    Type: AWS::SQS::Queue
    Properties:
      QueueName: lambda-scheduled-dlq
          ...
          - Sid: AllowEventBridgePublish
            ...
            Condition:
              StringEquals:
                AWS:SourceAccount: !Ref AWS::AccountId
              ArnEquals:
                aws:SourceArn: !GetAtt FrequentLambdaRule.Arn""",
...
data "aws_iam_policy_document" "eventbridge_dlq_policy" {
  statement {
    ...
    condition {
      ...
      values   = [aws_cloudwatch_event_rule.frequent_lambda.arn]
    }
  }
}
  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Condition = {
        ...
        ArnEquals = {
          "aws:SourceArn" = aws_cloudwatch_event_rule.frequent_lambda.arn
        }
      }
    }]
  })
...
resource "google_monitoring_alert_policy" "function_frequency" {
  ...
  documentation {
    content = "Cloud Function executing frequently at regular intervals. Review for scheduled chunked transfers."
        ...
        # Azure Strategy: Data Transfer Size Limits
        DetectionStrategy(
            strategy_id="t1030-azure",
            name="Azure Data Transfer Size Limits Detection",
            description=(
                "Azure detection for Data Transfer Size Limits. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Data Transfer Size Limits Detection
// Technique: T1030
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Data Transfer Size Limits
# MITRE ATT&CK: T1030
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "data-transfer-size-limits-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "data-transfer-size-limits-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Data Transfer Size Limits Detection
// Technique: T1030
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects Data Transfer Size Limits (T1030) activity in Azure environment"
  display_name = "Data Transfer Size Limits Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Data Transfer Size Limits Detected",
                alert_description_template=(
                    "Data Transfer Size Limits activity detected. "
