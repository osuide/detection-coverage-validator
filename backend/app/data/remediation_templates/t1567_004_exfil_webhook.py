  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Exfiltration Over Webhook
        DetectionStrategy(
            strategy_id="t1567004-azure",
            name="Azure Exfiltration Over Webhook Detection",
            description=(
                "Azure detection for Exfiltration Over Webhook. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Exfiltration Over Webhook Detection
// Technique: T1567.004
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Exfiltration Over Webhook
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "exfiltration-over-webhook-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "exfiltration-over-webhook-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Exfiltration Over Webhook Detection
// Technique: T1567.004
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects Exfiltration Over Webhook (T1567.004) activity in Azure environment"
  display_name = "Exfiltration Over Webhook Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1567.004"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Exfiltration Over Webhook Detected",
                alert_description_template=(
                    "Exfiltration Over Webhook activity detected. "
