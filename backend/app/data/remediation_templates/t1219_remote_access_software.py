...
resource "google_pubsub_subscription" "scc_email" {
  ...
  ack_deadline_seconds = 20
        ...
        # Azure Strategy: Remote Access Tools
        DetectionStrategy(
            strategy_id="t1219-azure",
            name="Azure Remote Access Tools Detection",
            description=(
                "Azure detection for Remote Access Tools. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Remote Access Tools
// MITRE ATT&CK: T1219
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Remote Access Tools
# MITRE ATT&CK: T1219
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "remote-access-tools-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "remote-access-tools-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Remote Access Tools
// MITRE ATT&CK: T1219
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Remote Access Tools (T1219) activity in Azure environment"
  display_name = "Remote Access Tools Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1219"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Remote Access Tools Detected",
                alert_description_template=(
                    "Remote Access Tools activity detected. "
