...
resource "google_monitoring_alert_policy" "secret_access" {
  ...
  documentation {
    content = "Automated credential collection detected via Secret Manager (T1119)"
        ...
        # Azure Strategy: Automated Collection
        DetectionStrategy(
            strategy_id="t1119-azure",
            name="Azure Automated Collection Detection",
            description=(
                "Sentinel detects automated collection patterns. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Automated Collection
// MITRE ATT&CK: T1119
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Automated Collection
# MITRE ATT&CK: T1119
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "automated-collection-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Automated Collection
// MITRE ATT&CK: T1119
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Automated Collection (T1119) activity in Azure environment"
  display_name = "Automated Collection Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1119"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Automated Collection Detected",
                alert_description_template=(
                    "Automated Collection activity detected. "
