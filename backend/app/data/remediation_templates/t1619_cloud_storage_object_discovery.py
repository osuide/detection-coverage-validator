  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Cloud Storage Object Discovery
        DetectionStrategy(
            strategy_id="t1619-azure",
            name="Azure Cloud Storage Object Discovery Detection",
            description=(
                "Azure detection for Cloud Storage Object Discovery. "
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "cloud-storage-object-discovery-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "cloud-storage-object-discovery-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Cloud Storage Object Discovery Detection
// Technique: T1619
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects Cloud Storage Object Discovery (T1619) activity in Azure environment"
  display_name = "Cloud Storage Object Discovery Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1619"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Cloud Storage Object Discovery Detected",
                alert_description_template=(
                    "Cloud Storage Object Discovery activity detected. "
