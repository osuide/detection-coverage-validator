...
output "alert_policy_name" {
  ...
  description = "Alert policy name for timed transfers"
        ...
        # Azure Strategy: Scheduled Transfer
        DetectionStrategy(
            strategy_id="t1029-azure",
            name="Azure Scheduled Transfer Detection",
            description=(
                "Azure detection for Scheduled Transfer. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Scheduled Transfer Detection
// Technique: T1029
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Scheduled Transfer
# MITRE ATT&CK: T1029
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "scheduled-transfer-detection"
  resource_group_name = var.resource_group_name
...
| order by OperationCount desc
  ...
  description = "Detects Scheduled Transfer (T1029) activity in Azure environment"
  display_name = "Scheduled Transfer Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Scheduled Transfer Detected",
                alert_description_template=(
                    "Scheduled Transfer activity detected. "
