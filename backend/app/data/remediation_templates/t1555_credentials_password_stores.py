...
resource "aws_cloudwatch_metric_alarm" "k8s_secrets" {
  ...
  alarm_actions       = [aws_sns_topic.k8s_secrets_alerts.arn]
        ...
        # Azure Strategy: Credentials from Password Stores
        DetectionStrategy(
            strategy_id="t1555-azure",
            name="Azure Credentials from Password Stores Detection",
            description=(
                "Azure detection for Credentials from Password Stores. "
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Credentials from Password Stores Detected",
                alert_description_template=(
                    "Credentials from Password Stores activity detected. "
