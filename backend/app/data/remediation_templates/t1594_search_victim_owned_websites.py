...
resource "aws_cloudwatch_metric_alarm" "form_abuse_detection" {
  ...
  alarm_actions       = [aws_sns_topic.alerts.arn]
        ...
        # Azure Strategy: Search Victim-Owned Websites
        DetectionStrategy(
            strategy_id="t1594-azure",
            name="Azure Search Victim-Owned Websites Detection",
            description=(
                "Azure detection for Search Victim-Owned Websites. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Search Victim-Owned Websites Detection
// Technique: T1594
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Search Victim-Owned Websites
# MITRE ATT&CK: T1594
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "search-victim-owned-websites-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "search-victim-owned-websites-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Search Victim-Owned Websites Detection
// Technique: T1594
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects Search Victim-Owned Websites (T1594) activity in Azure environment"
  display_name = "Search Victim-Owned Websites Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1594"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Search Victim-Owned Websites Detected",
                alert_description_template=(
                    "Search Victim-Owned Websites activity detected. "
