  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Exfiltration Over Web Service: Exfiltration to Code Repository
        DetectionStrategy(
            strategy_id="t1567001-azure",
            name="Azure Exfiltration Over Web Service: Exfiltration to Code Repository Detection",
            description=(
                "Azure detection for Exfiltration Over Web Service: Exfiltration to Code Repository. "
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "exfiltration-over-web-service--exfiltration-to-cod-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "exfiltration-over-web-service--exfiltration-to-cod-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Exfiltration Over Web Service: Exfiltration to Code Repository Detection
// Technique: T1567.001
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects Exfiltration Over Web Service: Exfiltration to Code Repository (T1567.001) activity in Azure environment"
  display_name = "Exfiltration Over Web Service: Exfiltration to Code Repository Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1567.001"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Exfiltration Over Web Service: Exfiltration to Code Repository Detected",
                alert_description_template=(
                    "Exfiltration Over Web Service: Exfiltration to Code Repository activity detected. "
