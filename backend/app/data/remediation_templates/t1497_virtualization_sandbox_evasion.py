...
resource "google_monitoring_alert_policy" "function_evasion" {
  ...
  documentation {
    ...
    EOT
        ...
        # Azure Strategy: Virtualization/Sandbox Evasion
        DetectionStrategy(
            strategy_id="t1497-azure",
            name="Azure Virtualization/Sandbox Evasion Detection",
            description=(
                "Azure detection for Virtualization/Sandbox Evasion. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Virtualization/Sandbox Evasion
// MITRE ATT&CK: T1497
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Virtualization/Sandbox Evasion
# MITRE ATT&CK: T1497
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "virtualization-sandbox-evasion-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "virtualization-sandbox-evasion-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Virtualization/Sandbox Evasion
// MITRE ATT&CK: T1497
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Virtualization/Sandbox Evasion (T1497) activity in Azure environment"
  display_name = "Virtualization/Sandbox Evasion Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1497"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Virtualization/Sandbox Evasion Detected",
                alert_description_template=(
                    "Virtualization/Sandbox Evasion activity detected. "
