...
data "aws_iam_policy_document" "eventbridge_dlq_policy" {
  statement {
    ...
    condition {
      ...
      values   = [aws_cloudwatch_event_rule.network_interface.arn]
    }
  }
}
  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Exfiltration Over Other Network Medium
        DetectionStrategy(
            strategy_id="t1011-azure",
            name="Azure Exfiltration Over Other Network Medium Detection",
            description=(
                "Azure detection for Exfiltration Over Other Network Medium. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Exfiltration Over Other Network Medium Detection
// Technique: T1011
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Exfiltration Over Other Network Medium
# MITRE ATT&CK: T1011
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  ...
  criteria {
    query = <<-QUERY
// Exfiltration Over Other Network Medium Detection
// Technique: T1011
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects Exfiltration Over Other Network Medium (T1011) activity in Azure environment"
  display_name = "Exfiltration Over Other Network Medium Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Exfiltration Over Other Network Medium Detected",
                alert_description_template=(
                    "Exfiltration Over Other Network Medium activity detected. "
