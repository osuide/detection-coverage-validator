  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Network Denial of Service: Direct Network Flood
        DetectionStrategy(
            strategy_id="t1498001-azure",
            name="Azure Network Denial of Service: Direct Network Flood Detection",
            description=(
                "Azure detection for Network Denial of Service: Direct Network Flood. "
...
# Microsoft Defender detects Network Denial of Service: Direct Network Flood activity
...
resource "azurerm_monitor_action_group" "defender_alerts" {
  name                = "defender-t1498-001-alerts"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Network Denial of Service: Direct Network Flood Detected",
                alert_description_template=(
                    "Network Denial of Service: Direct Network Flood activity detected. "
