...
resource "google_scc_notification_config" "console_anomaly" {
  ...
  pubsub_topic = google_pubsub_topic.scc_notifications.id
        ...
        # Azure Strategy: Cloud Service Dashboard
        DetectionStrategy(
            strategy_id="t1538-azure",
            name="Azure Cloud Service Dashboard Detection",
            description=(
                "Azure detection for Cloud Service Dashboard. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Cloud Service Dashboard Detection
// Technique: T1538
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Cloud Service Dashboard
# MITRE ATT&CK: T1538
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "cloud-service-dashboard-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "cloud-service-dashboard-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Cloud Service Dashboard Detection
// Technique: T1538
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects Cloud Service Dashboard (T1538) activity in Azure environment"
  display_name = "Cloud Service Dashboard Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1538"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Cloud Service Dashboard Detected",
                alert_description_template=(
                    "Cloud Service Dashboard activity detected. "
