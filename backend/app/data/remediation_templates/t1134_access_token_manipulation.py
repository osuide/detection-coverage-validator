        ...
        Statement:
          - Effect: Allow
            ...
            Condition:
              ...
              ArnEquals:
                aws:SourceArn: !GetAtt TokenManipulationRule.Arn""",
...
resource "aws_cloudwatch_log_metric_filter" "user_context_mismatch" {
  ...
  metric_transformation {
    ...
    value     = "1"
        ...
        # Azure Strategy: Access Token Manipulation
        DetectionStrategy(
            strategy_id="t1134-azure",
            name="Azure Access Token Manipulation Detection",
            description=(
                "Azure detection for Access Token Manipulation. "
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Access Token Manipulation Detected",
                alert_description_template=(
                    "Access Token Manipulation activity detected. "
