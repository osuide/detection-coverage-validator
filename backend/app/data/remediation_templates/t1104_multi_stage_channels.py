...
resource "aws_sqs_queue" "dlq" {
  name                      = "guardduty-multi-stage-c2-dlq"
  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Multi-Stage Channels
        DetectionStrategy(
            strategy_id="t1104-azure",
            name="Azure Multi-Stage Channels Detection",
            description=(
                "Azure detection for Multi-Stage Channels. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Multi-Stage Channels
// MITRE ATT&CK: T1104
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Multi-Stage Channels
# MITRE ATT&CK: T1104
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "multi-stage-channels-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "multi-stage-channels-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Multi-Stage Channels
// MITRE ATT&CK: T1104
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Multi-Stage Channels (T1104) activity in Azure environment"
  display_name = "Multi-Stage Channels Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Multi-Stage Channels Detected",
                alert_description_template=(
                    "Multi-Stage Channels activity detected. "
