...
resource "aws_cloudwatch_metric_alarm" "ticket_injection" {
  ...
  alarm_actions       = [aws_sns_topic.alerts.arn]
        ...
        # Azure Strategy: Use Alternate Authentication Material: Pass the Ticket
        DetectionStrategy(
            strategy_id="t1550003-azure",
            name="Azure Use Alternate Authentication Material: Pass the Ticket Detection",
            description=(
                "Azure detection for Use Alternate Authentication Material: Pass the Ticket. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Use Alternate Authentication Material: Pass the Ticket
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Use Alternate Authentication Material: Pass the Ticket
# MITRE ATT&CK: T1550.003
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Use Alternate Authentication Material: Pass the Ticket
// MITRE ATT&CK: T1550.003
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Use Alternate Authentication Material: Pass the Ticket (T1550.003) activity in Azure environment"
  display_name = "Use Alternate Authentication Material: Pass the Ticket Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1550.003"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Use Alternate Authentication Material: Pass the Ticket Detected",
                alert_description_template=(
                    "Use Alternate Authentication Material: Pass the Ticket activity detected. "
