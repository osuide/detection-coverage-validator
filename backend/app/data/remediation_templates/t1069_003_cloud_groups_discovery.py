  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Permission Groups Discovery: Cloud Groups
        DetectionStrategy(
            strategy_id="t1069003-azure",
            name="Azure Permission Groups Discovery: Cloud Groups Detection",
            description=(
                "Azure detection for Permission Groups Discovery: Cloud Groups. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Permission Groups Discovery: Cloud Groups Detection
// Technique: T1069.003
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Permission Groups Discovery: Cloud Groups
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "permission-groups-discovery--cloud-groups-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "permission-groups-discovery--cloud-groups-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Permission Groups Discovery: Cloud Groups Detection
// Technique: T1069.003
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects Permission Groups Discovery: Cloud Groups (T1069.003) activity in Azure environment"
  display_name = "Permission Groups Discovery: Cloud Groups Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1069.003"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Permission Groups Discovery: Cloud Groups Detected",
                alert_description_template=(
                    "Permission Groups Discovery: Cloud Groups activity detected. "
