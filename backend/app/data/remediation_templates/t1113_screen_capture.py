...
data "aws_iam_policy_document" "eventbridge_dlq_policy" {
  statement {
    ...
    condition {
      ...
      values   = [aws_cloudwatch_event_rule.screenshot.arn]
    }
  }
}
...
resource "google_monitoring_alert_policy" "remote_desktop" {
  ...
  documentation {
    content = "Suspicious remote desktop activity detected - potential screen capture threat (T1113)"
        ...
        # Azure Strategy: Screen Capture
        DetectionStrategy(
            strategy_id="t1113-azure",
            name="Azure Screen Capture Detection",
            description=(
                "Azure detection for Screen Capture. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Screen Capture Detection
// Technique: T1113
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Screen Capture
# MITRE ATT&CK: T1113
...
| order by OperationCount desc
  ...
  description = "Detects Screen Capture (T1113) activity in Azure environment"
  display_name = "Screen Capture Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Screen Capture Detected",
                alert_description_template=(
            ...
            detection_coverage="30% - only monitors Azure cloud operations, cannot detect endpoint screenshot activity",
