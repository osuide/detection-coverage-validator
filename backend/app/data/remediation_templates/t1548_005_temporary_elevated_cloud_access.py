  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Abuse Elevation Control Mechanism: Temporary Elevated Cloud Access
        DetectionStrategy(
            strategy_id="t1548005-azure",
            name="Azure Abuse Elevation Control Mechanism: Temporary Elevated Cloud Access Detection",
            description=(
                "Azure detection for Abuse Elevation Control Mechanism: Temporary Elevated Cloud Access. "
...
resource "azurerm_monitor_action_group" "defender_alerts" {
  name                = "defender-t1548-005-alerts"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Abuse Elevation Control Mechanism: Temporary Elevated Cloud Access Detected",
                alert_description_template=(
                    "Abuse Elevation Control Mechanism: Temporary Elevated Cloud Access activity detected. "
