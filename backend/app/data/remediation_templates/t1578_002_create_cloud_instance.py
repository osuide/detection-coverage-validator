...
resource "aws_sqs_queue_policy" "dlq_policy" {
  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Condition = {
        ArnEquals = {
          "aws:SourceArn" = aws_cloudwatch_event_rule.ec2_findings.arn
        }
      }
    }]
  })
        ...
        Statement:
          - Effect: Allow
            ...
            Condition:
              ...
              ArnEquals:
                aws:SourceArn: !GetAtt EC2CreateRule.Arn""",
  ...
  policy = jsonencode({
    ...
    Condition = {
        StringEquals = {
          ...
          ArnEquals = {
            "aws:SourceArn" = aws_cloudwatch_event_rule.ec2_create.arn
          }
      }
    }]
  })
  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Modify Cloud Compute Infrastructure: Create Cloud Instance
        DetectionStrategy(
            strategy_id="t1578002-azure",
            name="Azure Modify Cloud Compute Infrastructure: Create Cloud Instance Detection",
            description=(
                "Azure detection for Modify Cloud Compute Infrastructure: Create Cloud Instance. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Modify Cloud Compute Infrastructure: Create Cloud Instance
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Modify Cloud Compute Infrastructure: Create Cloud Instance
# MITRE ATT&CK: T1578.002
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "modify-cloud-compute-infrastructure--create-cloud--alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "modify-cloud-compute-infrastructure--create-cloud--detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Modify Cloud Compute Infrastructure: Create Cloud Instance
// MITRE ATT&CK: T1578.002
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Modify Cloud Compute Infrastructure: Create Cloud Instance (T1578.002) activity in Azure environment"
  display_name = "Modify Cloud Compute Infrastructure: Create Cloud Instance Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1578.002"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Modify Cloud Compute Infrastructure: Create Cloud Instance Detected",
                alert_description_template=(
                    "Modify Cloud Compute Infrastructure: Create Cloud Instance activity detected. "
