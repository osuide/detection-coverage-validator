...
data "aws_iam_policy_document" "eventbridge_dlq_policy" {
  statement {
    ...
    condition {
      ...
      values   = [aws_cloudwatch_event_rule.federated.arn]
    }
  }
}
  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Remote Services: Cloud Services
        DetectionStrategy(
            strategy_id="t1021007-azure",
            name="Azure Remote Services: Cloud Services Detection",
            description=(
                "Monitor cloud service access patterns. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Remote Services: Cloud Services Detection
// Technique: T1021.007
AzureActivity
| where TimeGenerated > ago(24h)
| where OperationNameValue contains "Microsoft.Compute/virtualMachines/" or OperationNameValue contains "Microsoft.Network/"
...
| order by TimeGenerated desc""",
                ...
                azure_terraform_template="""# Azure Detection for Remote Services: Cloud Services
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "remote-services--cloud-services-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "remote-services--cloud-services-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Remote Services: Cloud Services Detection
// Technique: T1021.007
AzureActivity
| where TimeGenerated > ago(24h)
| where OperationNameValue contains "Microsoft.Compute/virtualMachines/" or OperationNameValue contains "Microsoft.Network/"
...
| order by TimeGenerated desc
  ...
  description = "Detects Remote Services: Cloud Services (T1021.007) activity in Azure environment"
  display_name = "Remote Services: Cloud Services Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1021.007"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Remote Services: Cloud Services Detected",
                alert_description_template=(
                    "Remote Services: Cloud Services activity detected. "
    ...
    recommended_order=[
        "t1021007-aws-federation",
        "t1021007-aws-unusual",
        "t1021007-gcp-lateral",
    ],
