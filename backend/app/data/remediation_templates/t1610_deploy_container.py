  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Deploy Container
        DetectionStrategy(
            strategy_id="t1610-azure",
            name="Azure Deploy Container Detection",
            description=(
                "Azure detection for Deploy Container. "
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_description_template=(
                    "Deploy Container activity detected. "
