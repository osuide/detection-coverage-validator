...
Resources:
  ...
  DeadLetterQueue:
    Type: AWS::SQS::Queue
    Properties:
      QueueName: eventbridge-scheduler-dlq
      MessageRetentionPeriod: 1209600

  # Step 3: Detect EventBridge rule creation/modification
      ...
      Targets:
        - Id: SNSTarget
          ...
          InputTransformer:
            ...
            InputTemplate: |
              "EventBridge Scheduler Alert (T1053)
              time=<time> account=<account> region=<region>
              event=<eventName> user=<user>
              rule=<ruleName>
              Action: Verify scheduler change was authorised"
        ...
        Statement:
          - Sid: AllowEventBridgePublishScoped
            ...
            Condition:
              ...
              ArnEquals:
                aws:SourceArn: !GetAtt EventBridgeRuleDetection.Arn""",
...
resource "aws_sqs_queue" "dlq" {
  name                      = "eventbridge-scheduler-dlq"
...
data "aws_iam_policy_document" "eventbridge_dlq_policy" {
  statement {
    ...
    condition {
      ...
      values   = [aws_cloudwatch_event_rule.scheduler_changes.arn]
    }
  }
}
...
# Step 3: Detect EventBridge rule/schedule changes
  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Condition = {
        ...
        ArnEquals = {
          "aws:SourceArn" = aws_cloudwatch_event_rule.scheduler_changes.arn
        }
      }
    }]
  })
...
resource "google_monitoring_alert_policy" "cronjob_creation" {
  ...
  documentation {
    ...
    mime_type = "text/markdown"
        ...
        # Azure Strategy: Scheduled Task/Job
        DetectionStrategy(
            strategy_id="t1053-azure",
            name="Azure Scheduled Task/Job Detection",
            description=(
                "Azure detection for Scheduled Task/Job. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Scheduled Task/Job
// MITRE ATT&CK: T1053
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Scheduled Task/Job
# MITRE ATT&CK: T1053
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "scheduled-task-job-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "scheduled-task-job-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Scheduled Task/Job
// MITRE ATT&CK: T1053
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Scheduled Task/Job (T1053) activity in Azure environment"
  display_name = "Scheduled Task/Job Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Scheduled Task/Job Detected",
                alert_description_template=(
                    "Scheduled Task/Job activity detected. "
