...
resource "aws_sqs_queue" "dlq" {
  name                      = "lateral-tool-transfer-dlq"
  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Lateral Tool Transfer
        DetectionStrategy(
            strategy_id="t1570-azure",
            name="Azure Lateral Tool Transfer Detection",
            description=(
                "Azure detection for Lateral Tool Transfer. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Lateral Tool Transfer
// MITRE ATT&CK: T1570
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Lateral Tool Transfer
# MITRE ATT&CK: T1570
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "lateral-tool-transfer-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Lateral Tool Transfer
// MITRE ATT&CK: T1570
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Lateral Tool Transfer (T1570) activity in Azure environment"
  display_name = "Lateral Tool Transfer Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1570"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Lateral Tool Transfer Detected",
                alert_description_template=(
                    "Lateral Tool Transfer activity detected. "
