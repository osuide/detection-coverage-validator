...
resource "aws_cloudwatch_metric_alarm" "imds_access" {
  ...
  alarm_actions       = [aws_sns_topic.alerts.arn]
        ...
        # Azure Strategy: Unsecured Credentials: Cloud Instance Metadata API
        DetectionStrategy(
            strategy_id="t1552005-azure",
            name="Azure Unsecured Credentials: Cloud Instance Metadata API Detection",
            description=(
                "Azure detection for Unsecured Credentials: Cloud Instance Metadata API. "
...
resource "azurerm_monitor_action_group" "defender_alerts" {
  name                = "defender-t1552-005-alerts"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Unsecured Credentials: Cloud Instance Metadata API Detected",
                alert_description_template=(
                    "Unsecured Credentials: Cloud Instance Metadata API activity detected. "
