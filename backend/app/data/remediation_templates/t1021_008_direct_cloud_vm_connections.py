  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Remote Services: Direct Cloud VM Connections
        DetectionStrategy(
            strategy_id="t1021008-azure",
            name="Azure Remote Services: Direct Cloud VM Connections Detection",
            description=(
                "Azure detection for Remote Services: Direct Cloud VM Connections. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Remote Services: Direct Cloud VM Connections
// MITRE ATT&CK: T1021.008
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Remote Services: Direct Cloud VM Connections
# MITRE ATT&CK: T1021.008
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "remote-services--direct-cloud-vm-connections-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "remote-services--direct-cloud-vm-connections-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Remote Services: Direct Cloud VM Connections
// MITRE ATT&CK: T1021.008
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Remote Services: Direct Cloud VM Connections (T1021.008) activity in Azure environment"
  display_name = "Remote Services: Direct Cloud VM Connections Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1021.008"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Remote Services: Direct Cloud VM Connections Detected",
                alert_description_template=(
                    "Remote Services: Direct Cloud VM Connections activity detected. "
