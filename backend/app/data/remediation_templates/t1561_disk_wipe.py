  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Disk Wipe
        DetectionStrategy(
            strategy_id="t1561-azure",
            name="Azure Disk Wipe Detection",
            description=(
                "Azure detection for Disk Wipe. "
...
# Disk Wipe (T1561)
# Microsoft Defender detects Disk Wipe activity
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Disk Wipe Detected",
                alert_description_template=(
                    "Disk Wipe activity detected. "
