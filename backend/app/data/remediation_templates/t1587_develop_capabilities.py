  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Develop Capabilities
        DetectionStrategy(
            strategy_id="t1587-azure",
            name="Azure Develop Capabilities Detection",
            description=(
                "Azure detection for Develop Capabilities. "
...
# Microsoft Defender detects Develop Capabilities activity
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Develop Capabilities Detected",
                alert_description_template=(
                    "Develop Capabilities activity detected. "
