...
data "aws_iam_policy_document" "eventbridge_dlq_policy" {
  statement {
    ...
    condition {
      ...
      values   = [aws_cloudwatch_event_rule.masquerading.arn]
    }
  }
}
  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Masquerading
        DetectionStrategy(
            strategy_id="t1036-azure",
            name="Azure Masquerading Detection",
            description=(
                "Azure detection for Masquerading. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Masquerading
// MITRE ATT&CK: T1036
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Masquerading
# MITRE ATT&CK: T1036
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Masquerading
// MITRE ATT&CK: T1036
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Masquerading (T1036) activity in Azure environment"
  display_name = "Masquerading Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Masquerading Detected",
                alert_description_template=(
                    "Masquerading activity detected. "
