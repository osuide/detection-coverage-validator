        ...
        Statement:
          - Effect: Allow
            ...
            Condition:
              ...
              ArnEquals:
                aws:SourceArn: !GetAtt TimeDiscoveryRule.Arn""",
  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: System Time Discovery
        DetectionStrategy(
            strategy_id="t1124-azure",
            name="Azure System Time Discovery Detection",
            description=(
                "Azure detection for System Time Discovery. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// System Time Discovery Detection
// Technique: T1124
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for System Time Discovery
# MITRE ATT&CK: T1124
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "system-time-discovery-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// System Time Discovery Detection
// Technique: T1124
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects System Time Discovery (T1124) activity in Azure environment"
  display_name = "System Time Discovery Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1124"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: System Time Discovery Detected",
                alert_description_template=(
                    "System Time Discovery activity detected. "
