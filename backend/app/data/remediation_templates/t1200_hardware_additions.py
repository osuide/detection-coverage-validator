...
# - Host-based auditd rules: auditctl -w /dev -p wa -k peripheral_devices""",
        ...
        # Azure Strategy: Hardware Additions
        DetectionStrategy(
            strategy_id="t1200-azure",
            name="Azure Hardware Additions Detection",
            description=(
                "Azure detection for Hardware Additions. "
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Hardware Additions Detected",
                alert_description_template=(
                    "Hardware Additions activity detected. "
            ...
            detection_coverage="30% - only monitors Azure cloud operations, cannot detect physical hardware insertions",
