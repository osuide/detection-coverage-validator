        ...
        Statement:
          - Effect: Allow
            ...
            Condition:
              ...
              ArnEquals:
                aws:SourceArn: !GetAtt BackdoorRule.Arn""",
...
data "aws_iam_policy_document" "eventbridge_dlq_policy" {
  statement {
    ...
    condition {
      ...
      values   = [aws_cloudwatch_event_rule.backdoor.arn]
    }
  }
}
  ...
  policy = jsonencode({
    ...
    Condition = {
        StringEquals = {
          ...
          ArnEquals = {
            "aws:SourceArn" = aws_cloudwatch_event_rule.backdoor.arn
          }
      }
    }]
  })
  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Resource Hijacking: Bandwidth Hijacking
        DetectionStrategy(
            strategy_id="t1496002-azure",
            name="Azure Resource Hijacking: Bandwidth Hijacking Detection",
            description=(
                "Azure detection for Resource Hijacking: Bandwidth Hijacking. "
...
# Microsoft Defender detects Resource Hijacking: Bandwidth Hijacking activity
...
resource "azurerm_monitor_action_group" "defender_alerts" {
  name                = "defender-t1496-002-alerts"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Resource Hijacking: Bandwidth Hijacking Detected",
                alert_description_template=(
                    "Resource Hijacking: Bandwidth Hijacking activity detected. "
