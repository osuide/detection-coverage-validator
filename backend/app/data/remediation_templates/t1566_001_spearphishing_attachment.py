  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Phishing: Spearphishing Attachment
        DetectionStrategy(
            strategy_id="t1566001-azure",
            name="Azure Phishing: Spearphishing Attachment Detection",
            description=(
                "Azure detection for Phishing: Spearphishing Attachment. "
...
resource "azurerm_monitor_action_group" "defender_alerts" {
  name                = "defender-t1566-001-alerts"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Phishing: Spearphishing Attachment Detected",
                alert_description_template=(
                    "Phishing: Spearphishing Attachment activity detected. "
