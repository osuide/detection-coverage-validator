...
resource "google_monitoring_alert_policy" "instance_debug_checks" {
  ...
  documentation {
    ...
    EOT
        ...
        # Azure Strategy: Debugger Evasion
        DetectionStrategy(
            strategy_id="t1622-azure",
            name="Azure Debugger Evasion Detection",
            description=(
                "Azure detection for Debugger Evasion. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Debugger Evasion
// MITRE ATT&CK: T1622
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Debugger Evasion
# MITRE ATT&CK: T1622
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "debugger-evasion-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Debugger Evasion
// MITRE ATT&CK: T1622
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Debugger Evasion (T1622) activity in Azure environment"
  display_name = "Debugger Evasion Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1622"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Debugger Evasion Detected",
                alert_description_template=(
                    "Debugger Evasion activity detected. "
