...
resource "aws_cloudwatch_event_rule" "ddos_findings" {
  ...
  event_pattern = jsonencode({
    ...
    detail = {
      type = [{
        prefix = "Backdoor:EC2/DenialOfService.Tcp"
      }]
    }
  })
}
...
data "aws_iam_policy_document" "eventbridge_dlq_policy" {
  statement {
    ...
    condition {
      ...
      values   = [aws_cloudwatch_event_rule.ddos_findings.arn]
    }
  }
}
...
resource "aws_sns_topic_policy" "allow_eventbridge" {
  ...
  policy = jsonencode({
    ...
    Condition = {
        ...
        ArnEquals = {
          "aws:SourceArn" = aws_cloudwatch_event_rule.ddos_findings.arn
        }
      }
    }]
  })
...
resource "google_monitoring_alert_policy" "amplification_attack" {
  ...
  documentation {
    content = "Potential reflection amplification attack originating from GCP instance. Investigate source VM immediately."
        ...
        # Azure Strategy: Network Denial of Service: Reflection Amplification
        DetectionStrategy(
            strategy_id="t1498002-azure",
            name="Azure Network Denial of Service: Reflection Amplification Detection",
            description=(
                "Azure detection for Network Denial of Service: Reflection Amplification. "
...
# Microsoft Defender detects Network Denial of Service: Reflection Amplification activity
...
resource "azurerm_monitor_action_group" "defender_alerts" {
  name                = "defender-t1498-002-alerts"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Network Denial of Service: Reflection Amplification Detected",
                alert_description_template=(
                    "Network Denial of Service: Reflection Amplification activity detected. "
