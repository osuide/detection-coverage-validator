  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Condition = {
        ...
        # Azure Strategy: Data from Information Repositories: Databases
        DetectionStrategy(
            strategy_id="t1213006-azure",
            name="Azure Data from Information Repositories: Databases Detection",
            description=(
                "Azure detection for Data from Information Repositories: Databases. "
...
| order by OperationCount desc
  ...
  description = "Detects Data from Information Repositories: Databases (T1213.006) activity in Azure environment"
  display_name = "Data from Information Repositories: Databases Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1213.006"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Data from Information Repositories: Databases Detected",
                alert_description_template=(
                    "Data from Information Repositories: Databases activity detected. "
