...
data "aws_iam_policy_document" "eventbridge_dlq_policy" {
  statement {
    ...
    condition {
      ...
      values   = [aws_cloudwatch_event_rule.s3_archive_upload.arn]
    }
  }
}
...
resource "google_monitoring_alert_policy" "gcs_archive_upload" {
  ...
  documentation {
    content = "Archive file uploaded to Cloud Storage. Verify this is authorised activity and not data exfiltration (MITRE ATT&CK T1560)."
        ...
        # Azure Strategy: Archive Collected Data
        DetectionStrategy(
            strategy_id="t1560-azure",
            name="Azure Archive Collected Data Detection",
            description=(
                "Azure detection for Archive Collected Data. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Archive Collected Data Detection
// Technique: T1560
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Archive Collected Data
# MITRE ATT&CK: T1560
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "archive-collected-data-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  ...
  criteria {
    query = <<-QUERY
// Archive Collected Data Detection
// Technique: T1560
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects Archive Collected Data (T1560) activity in Azure environment"
  display_name = "Archive Collected Data Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1560"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Archive Collected Data Detected",
                alert_description_template=(
                    "Archive Collected Data activity detected. "
