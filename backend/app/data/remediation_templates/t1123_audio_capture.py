...
resource "google_monitoring_alert_policy" "audio_uploads" {
  ...
  documentation {
    ...
    mime_type = "text/markdown"
        ...
        # Azure Strategy: Audio Capture
        DetectionStrategy(
            strategy_id="t1123-azure",
            name="Azure Audio Capture Detection",
            description=(
                "Azure detection for Audio Capture. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Audio Capture Detection
// Technique: T1123
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Audio Capture
# MITRE ATT&CK: T1123
...
| order by OperationCount desc
  ...
  description = "Detects Audio Capture (T1123) activity in Azure environment"
  display_name = "Audio Capture Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Audio Capture Detected",
                alert_description_template=(
                    "Audio Capture activity detected. "
            ...
            detection_coverage="30% - only monitors Azure cloud operations, cannot detect endpoint microphone access",
