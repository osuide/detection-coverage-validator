...
resource "aws_cloudwatch_metric_alarm" "audio_files" {
  ...
  alarm_actions       = [aws_sns_topic.alerts.arn]
            ...
            detection_coverage="70% - catches audio file creation in common temporary locations",
...
resource "aws_cloudwatch_metric_alarm" "audio_tools" {
  ...
  alarm_actions       = [aws_sns_topic.alerts.arn]
            ...
            detection_coverage="85% - catches known audio capture tool signatures",
...
resource "google_monitoring_alert_policy" "audio_capture" {
  ...
  documentation {
    ...
    mime_type = "text/markdown"
            ...
            detection_coverage="75% - detects common audio capture patterns on Linux",
...
resource "google_monitoring_alert_policy" "audio_uploads" {
  ...
  documentation {
    ...
    mime_type = "text/markdown"
            ...
            detection_coverage="80% - catches audio file uploads from compute service accounts",
