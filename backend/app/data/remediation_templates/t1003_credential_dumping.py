...
resource "aws_cloudwatch_metric_alarm" "credential_dumping" {
  ...
  alarm_actions       = [aws_sns_topic.alerts.arn]
            ...
            detection_coverage="85% - catches known tool signatures",
...
resource "aws_cloudwatch_log_metric_filter" "privileged_containers" {
  ...
  metric_transformation {
    ...
    value     = "1"
            ...
            detection_coverage="65% - covers common container credential access patterns",
...
resource "google_monitoring_alert_policy" "credential_dumping" {
  ...
  documentation {
    ...
    mime_type = "text/markdown"
            ...
            detection_coverage="75% - detects common credential dumping patterns",
...
resource "aws_cloudwatch_metric_alarm" "bulk_secrets_access" {
  ...
  alarm_actions       = [aws_sns_topic.alerts.arn]
            ...
            detection_coverage="60% - catches bulk credential harvesting",
