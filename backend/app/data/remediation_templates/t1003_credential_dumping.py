...
resource "aws_cloudwatch_metric_alarm" "bulk_secrets_access" {
  ...
  alarm_actions       = [aws_sns_topic.alerts.arn]
        ...
        # Azure Strategy: OS Credential Dumping
        DetectionStrategy(
            strategy_id="t1003-azure",
            name="Azure OS Credential Dumping Detection",
            description=(
                "Azure detection for OS Credential Dumping. "
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: OS Credential Dumping Detected",
                alert_description_template=(
                    "OS Credential Dumping activity detected. "
            ...
            detection_coverage="30% - only monitors Azure cloud operations, cannot detect endpoint credential dumping",
