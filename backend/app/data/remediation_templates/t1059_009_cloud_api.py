...
resource "aws_cloudwatch_metric_alarm" "high_cli_usage" {
  ...
  treat_missing_data  = "notBreaching"
        ...
        # Azure Strategy: Command and Scripting Interpreter: Cloud API
        DetectionStrategy(
            strategy_id="t1059009-azure",
            name="Azure Command and Scripting Interpreter: Cloud API Detection",
            description=(
                "Azure detection for Command and Scripting Interpreter: Cloud API. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Command and Scripting Interpreter: Cloud API
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Command and Scripting Interpreter: Cloud API
# MITRE ATT&CK: T1059.009
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Command and Scripting Interpreter: Cloud API
// MITRE ATT&CK: T1059.009
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Command and Scripting Interpreter: Cloud API (T1059.009) activity in Azure environment"
  display_name = "Command and Scripting Interpreter: Cloud API Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1059.009"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Command and Scripting Interpreter: Cloud API Detected",
                alert_description_template=(
                    "Command and Scripting Interpreter: Cloud API activity detected. "
