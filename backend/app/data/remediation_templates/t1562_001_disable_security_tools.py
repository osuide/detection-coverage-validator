  ...
  ConfigTamperingAlarm:
    ...
    Properties:
      ...
      AlarmActions:
        ...
        # Azure Strategy: Impair Defences: Disable or Modify Tools
        DetectionStrategy(
            strategy_id="t1562001-azure",
            name="Azure Impair Defences: Disable or Modify Tools Detection",
            description=(
                "Azure detection for Impair Defences: Disable or Modify Tools. "
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "impair-defences--disable-or-modify-tools-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "impair-defences--disable-or-modify-tools-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Impair Defences: Disable or Modify Tools
// MITRE ATT&CK: T1562.001
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Impair Defences: Disable or Modify Tools (T1562.001) activity in Azure environment"
  display_name = "Impair Defences: Disable or Modify Tools Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Impair Defences: Disable or Modify Tools Detected",
                alert_description_template=(
                    "Impair Defences: Disable or Modify Tools activity detected. "
