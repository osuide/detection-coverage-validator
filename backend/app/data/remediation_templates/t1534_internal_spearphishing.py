  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Internal Spearphishing
        DetectionStrategy(
            strategy_id="t1534-azure",
            name="Azure Internal Spearphishing Detection",
            description=(
                "Azure detection for Internal Spearphishing. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Internal Spearphishing
// MITRE ATT&CK: T1534
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Internal Spearphishing
# MITRE ATT&CK: T1534
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "internal-spearphishing-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Internal Spearphishing
// MITRE ATT&CK: T1534
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Internal Spearphishing (T1534) activity in Azure environment"
  display_name = "Internal Spearphishing Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Internal Spearphishing Detected",
                alert_description_template=(
                    "Internal Spearphishing activity detected. "
