...
output "notification_channel_id" {
  ...
  description = "Notification channel for alerts"
        ...
        # Azure Strategy: Serverless Execution
        DetectionStrategy(
            strategy_id="t1648-azure",
            name="Azure Serverless Execution Detection",
            description=(
                "Azure detection for Serverless Execution. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Serverless Execution
// MITRE ATT&CK: T1648
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Serverless Execution
# MITRE ATT&CK: T1648
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Serverless Execution
// MITRE ATT&CK: T1648
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Serverless Execution (T1648) activity in Azure environment"
  display_name = "Serverless Execution Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1648"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Serverless Execution Detected",
                alert_description_template=(
                    "Serverless Execution activity detected. "
