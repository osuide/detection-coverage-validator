  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Data Destruction: Cloud Storage Object Deletion
        DetectionStrategy(
            strategy_id="t1485001-azure",
            name="Azure Data Destruction: Cloud Storage Object Deletion Detection",
            description=(
                "Azure detection for Data Destruction: Cloud Storage Object Deletion. "
...
resource "azurerm_monitor_action_group" "defender_alerts" {
  name                = "defender-t1485-001-alerts"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Data Destruction: Cloud Storage Object Deletion Detected",
                alert_description_template=(
                    "Data Destruction: Cloud Storage Object Deletion activity detected. "
