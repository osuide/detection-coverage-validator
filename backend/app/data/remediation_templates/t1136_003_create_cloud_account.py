...
resource "google_monitoring_alert_policy" "wif_creation" {
  ...
  documentation {
    ...
    mime_type = "text/markdown"
        ...
        # Azure Strategy: Create Account: Cloud Account
        DetectionStrategy(
            strategy_id="t1136003-azure",
            name="Azure Create Account: Cloud Account Detection",
            description=(
                "Monitor cloud account creation in Entra ID. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Create Account: Cloud Account Detection
// Technique: T1136.003
AzureActivity
| where TimeGenerated > ago(24h)
| where OperationNameValue contains "Microsoft.AAD/domainServices/" or OperationNameValue contains "Microsoft.Authorization/"
...
| order by TimeGenerated desc""",
                ...
                azure_terraform_template="""# Azure Detection for Create Account: Cloud Account
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "create-account--cloud-account-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "create-account--cloud-account-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Create Account: Cloud Account Detection
// Technique: T1136.003
AzureActivity
| where TimeGenerated > ago(24h)
| where OperationNameValue contains "Microsoft.AAD/domainServices/" or OperationNameValue contains "Microsoft.Authorization/"
...
| order by TimeGenerated desc
  ...
  description = "Detects Create Account: Cloud Account (T1136.003) activity in Azure environment"
  display_name = "Create Account: Cloud Account Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1136.003"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Create Account: Cloud Account Detected",
                alert_description_template=(
                    "Create Account: Cloud Account activity detected. "
