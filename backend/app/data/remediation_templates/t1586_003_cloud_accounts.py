  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Compromise Accounts: Cloud Accounts
        DetectionStrategy(
            strategy_id="t1586003-azure",
            name="Azure Compromise Accounts: Cloud Accounts Detection",
            description=(
                "Azure detection for Compromise Accounts: Cloud Accounts. "
...
resource "azurerm_monitor_action_group" "defender_alerts" {
  name                = "defender-t1586-003-alerts"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Compromise Accounts: Cloud Accounts Detected",
                alert_description_template=(
                    "Compromise Accounts: Cloud Accounts activity detected. "
