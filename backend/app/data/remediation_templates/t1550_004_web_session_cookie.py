  ...
  alert_strategy {
    notification_rate_limit {
      period = "3600s"
        ...
        # Azure Strategy: Use Alternate Authentication Material: Web Session Cookie
        DetectionStrategy(
            strategy_id="t1550004-azure",
            name="Azure Use Alternate Authentication Material: Web Session Cookie Detection",
            description=(
                "Azure detection for Use Alternate Authentication Material: Web Session Cookie. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Use Alternate Authentication Material: Web Session Cookie
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Use Alternate Authentication Material: Web Session Cookie
# MITRE ATT&CK: T1550.004
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "use-alternate-authentication-material--web-session-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "use-alternate-authentication-material--web-session-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Use Alternate Authentication Material: Web Session Cookie
// MITRE ATT&CK: T1550.004
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Use Alternate Authentication Material: Web Session Cookie (T1550.004) activity in Azure environment"
  display_name = "Use Alternate Authentication Material: Web Session Cookie Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1550.004"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Use Alternate Authentication Material: Web Session Cookie Detected",
                alert_description_template=(
                    "Use Alternate Authentication Material: Web Session Cookie activity detected. "
