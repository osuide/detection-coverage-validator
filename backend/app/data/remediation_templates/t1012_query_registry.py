...
resource "google_monitoring_alert_policy" "registry_queries" {
  ...
  documentation {
    ...
    mime_type = "text/markdown"
        ...
        # Azure Strategy: Query Registry
        DetectionStrategy(
            strategy_id="t1012-azure",
            name="Azure Query Registry Detection",
            description=(
                "Azure detection for Query Registry. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Query Registry Detection
// Technique: T1012
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Query Registry
# MITRE ATT&CK: T1012
...
| order by OperationCount desc
  ...
  description = "Detects Query Registry (T1012) activity in Azure environment"
  display_name = "Query Registry Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Query Registry Detected",
                alert_description_template=(
                    "Query Registry activity detected. "
