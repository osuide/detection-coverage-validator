...
resource "google_monitoring_alert_policy" "browser_enum_process" {
  ...
  documentation {
    ...
    EOT
        ...
        # Azure Strategy: Browser Information Discovery
        DetectionStrategy(
            strategy_id="t1217-azure",
            name="Azure Browser Information Discovery Detection",
            description=(
                "Azure detection for Browser Information Discovery. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Browser Information Discovery Detection
// Technique: T1217
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Browser Information Discovery
# MITRE ATT&CK: T1217
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "browser-information-discovery-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "browser-information-discovery-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Browser Information Discovery Detection
// Technique: T1217
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects Browser Information Discovery (T1217) activity in Azure environment"
  display_name = "Browser Information Discovery Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1217"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Browser Information Discovery Detected",
                alert_description_template=(
                    "Browser Information Discovery activity detected. "
