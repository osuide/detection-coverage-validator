...
resource "google_monitoring_alert_policy" "bigquery_access" {
  ...
  documentation {
    content = "Unusual BigQuery data repository access detected (T1213)"
        ...
        # Azure Strategy: Data from Information Repositories
        DetectionStrategy(
            strategy_id="t1213-azure",
            name="Azure Data from Information Repositories Detection",
            description=(
                "Azure detection for Data from Information Repositories. "
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "data-from-information-repositories-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "data-from-information-repositories-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Data from Information Repositories Detection
// Technique: T1213
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects Data from Information Repositories (T1213) activity in Azure environment"
  display_name = "Data from Information Repositories Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Data from Information Repositories Detected",
                alert_description_template=(
                    "Data from Information Repositories activity detected. "
