  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Server Software Component
        DetectionStrategy(
            strategy_id="t1505-azure",
            name="Azure Server Software Component Detection",
            description=(
                "Azure detection for Server Software Component. "
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Server Software Component Detected",
                alert_description_template=(
                    "Server Software Component activity detected. "
