  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Local Storage Discovery
        DetectionStrategy(
            strategy_id="t1680-azure",
            name="Azure Local Storage Discovery Detection",
            description=(
                "Azure detection for Local Storage Discovery. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Local Storage Discovery Detection
// Technique: T1680
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Local Storage Discovery
# MITRE ATT&CK: T1680
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  ...
  criteria {
    query = <<-QUERY
// Local Storage Discovery Detection
// Technique: T1680
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects Local Storage Discovery (T1680) activity in Azure environment"
  display_name = "Local Storage Discovery Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1680"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Local Storage Discovery Detected",
                alert_description_template=(
                    "Local Storage Discovery activity detected. "
