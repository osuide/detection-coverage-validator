        ...
        Statement:
          - Effect: Allow
            ...
            Condition:
              ...
              ArnEquals:
                aws:SourceArn: !GetAtt SSOFederationRule.Arn""",
  ...
  policy = jsonencode({
    ...
    Condition = {
        StringEquals = {
          ...
          ArnEquals = {
            "aws:SourceArn" = aws_cloudwatch_event_rule.sso_federation.arn
          }
      }
    }]
  })
...
resource "google_monitoring_alert_policy" "sso_config" {
  ...
  documentation {
    content = "Hybrid identity or SAML SSO configuration was modified. Verify this change was authorised."
        ...
        # Azure Strategy: Modify Authentication Process: Hybrid Identity
        DetectionStrategy(
            strategy_id="t1556007-azure",
            name="Azure Modify Authentication Process: Hybrid Identity Detection",
            description=(
                "Azure detection for Modify Authentication Process: Hybrid Identity. "
...
# Microsoft Defender detects Modify Authentication Process: Hybrid Identity activity
...
resource "azurerm_monitor_action_group" "defender_alerts" {
  name                = "defender-t1556-007-alerts"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Modify Authentication Process: Hybrid Identity Detected",
                alert_description_template=(
                    "Modify Authentication Process: Hybrid Identity activity detected. "
