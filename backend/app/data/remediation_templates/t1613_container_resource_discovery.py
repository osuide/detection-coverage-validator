  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Container and Resource Discovery
        DetectionStrategy(
            strategy_id="t1613-azure",
            name="Azure Container and Resource Discovery Detection",
            description=(
                "Azure detection for Container and Resource Discovery. "
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "container-and-resource-discovery-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "container-and-resource-discovery-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Container and Resource Discovery Detection
// Technique: T1613
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects Container and Resource Discovery (T1613) activity in Azure environment"
  display_name = "Container and Resource Discovery Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1613"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Container and Resource Discovery Detected",
                alert_description_template=(
                    "Container and Resource Discovery activity detected. "
