...
resource "aws_iam_role_policy_attachment" "config" {
  ...
  policy_arn = "arn:aws:iam::aws:policy/service-role/ConfigRole"
        ...
        # Azure Strategy: Hide Artifacts
        DetectionStrategy(
            strategy_id="t1564-azure",
            name="Azure Hide Artifacts Detection",
            description=(
                "Azure detection for Hide Artifacts. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Hide Artifacts
// MITRE ATT&CK: T1564
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Hide Artifacts
# MITRE ATT&CK: T1564
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Hide Artifacts
// MITRE ATT&CK: T1564
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Hide Artifacts (T1564) activity in Azure environment"
  display_name = "Hide Artifacts Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Hide Artifacts Detected",
                alert_description_template=(
                    "Hide Artifacts activity detected. "
