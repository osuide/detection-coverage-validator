        ...
        Statement:
          - Effect: Allow
            ...
            Condition:
              ...
              ArnEquals:
                aws:SourceArn: !GetAtt GuardDutyToolRule.Arn""",
...
resource "aws_sqs_queue" "dlq" {
  name                      = "guardduty-tool-detection-dlq"
  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Condition = {
        ...
        ArnEquals = {
          "aws:SourceArn" = aws_cloudwatch_event_rule.guardduty_tools.arn
        }
      }
    }]
  })
  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Obtain Capabilities: Tool
        DetectionStrategy(
            strategy_id="t1588002-azure",
            name="Azure Obtain Capabilities: Tool Detection",
            description=(
                "Azure detection for Obtain Capabilities: Tool. "
...
resource "azurerm_monitor_action_group" "defender_alerts" {
  name                = "defender-t1588-002-alerts"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Obtain Capabilities: Tool Detected",
                alert_description_template=(
                    "Obtain Capabilities: Tool activity detected. "
