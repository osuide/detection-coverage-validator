...
resource "google_monitoring_alert_policy" "system_profile" {
  ...
  documentation {
    ...
    mime_type = "text/markdown"
        ...
        # Azure Strategy: Virtualisation/Sandbox Evasion: System Checks
        DetectionStrategy(
            strategy_id="t1497001-azure",
            name="Azure Virtualisation/Sandbox Evasion: System Checks Detection",
            description=(
                "Azure detection for Virtualisation/Sandbox Evasion: System Checks. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Virtualisation/Sandbox Evasion: System Checks
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Virtualisation/Sandbox Evasion: System Checks
# MITRE ATT&CK: T1497.001
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "virtualisation-sandbox-evasion--system-checks-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "virtualisation-sandbox-evasion--system-checks-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Virtualisation/Sandbox Evasion: System Checks
// MITRE ATT&CK: T1497.001
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Virtualisation/Sandbox Evasion: System Checks (T1497.001) activity in Azure environment"
  display_name = "Virtualisation/Sandbox Evasion: System Checks Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1497.001"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Virtualisation/Sandbox Evasion: System Checks Detected",
                alert_description_template=(
                    "Virtualisation/Sandbox Evasion: System Checks activity detected. "
