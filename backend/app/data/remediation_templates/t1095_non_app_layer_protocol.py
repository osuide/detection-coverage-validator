        ...
        Statement:
          - Effect: Allow
            ...
            Condition:
              ...
              ArnEquals:
                aws:SourceArn: !GetAtt RawProtocolRule.Arn""",
...
data "aws_iam_policy_document" "eventbridge_dlq_policy" {
  statement {
    ...
    condition {
      ...
      values   = [aws_cloudwatch_event_rule.raw_protocol.arn]
    }
  }
}
  ...
  policy = jsonencode({
    ...
    Condition = {
        StringEquals = {
          ...
          ArnEquals = {
            "aws:SourceArn" = aws_cloudwatch_event_rule.raw_protocol.arn
          }
      }
    }]
  })
  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Non-Application Layer Protocol
        DetectionStrategy(
            strategy_id="t1095-azure",
            name="Azure Non-Application Layer Protocol Detection",
            description=(
                "Azure detection for Non-Application Layer Protocol. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Non-Application Layer Protocol
// MITRE ATT&CK: T1095
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Non-Application Layer Protocol
# MITRE ATT&CK: T1095
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "non-application-layer-protocol-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "non-application-layer-protocol-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Non-Application Layer Protocol
// MITRE ATT&CK: T1095
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Non-Application Layer Protocol (T1095) activity in Azure environment"
  display_name = "Non-Application Layer Protocol Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1095"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Non-Application Layer Protocol Detected",
                alert_description_template=(
                    "Non-Application Layer Protocol activity detected. "
