  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Resource  = aws_sns_topic.alerts.arn
            ...
            detection_coverage="65% - catches anomalous login behaviour patterns",
...
resource "aws_cloudwatch_metric_alarm" "failed_logins" {
  ...
  treat_missing_data  = "notBreaching"
            ...
            detection_coverage="70% - effective for credential testing patterns",
...
resource "aws_cloudwatch_metric_alarm" "session_tokens" {
  ...
  treat_missing_data  = "notBreaching"
            ...
            detection_coverage="55% - catches session token abuse patterns",
...
resource "google_monitoring_alert_policy" "suspicious_login_alert" {
  ...
  documentation {
    ...
    mime_type = "text/markdown"
            ...
            detection_coverage="70% - effective for authentication anomalies",
...
resource "google_monitoring_alert_policy" "token_volume" {
  ...
  documentation {
    ...
    mime_type = "text/markdown"
            ...
            detection_coverage="60% - catches unusual token generation",
