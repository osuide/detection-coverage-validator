...
resource "google_monitoring_alert_policy" "token_volume" {
  ...
  documentation {
    ...
    mime_type = "text/markdown"
        ...
        # Azure Strategy: Input Capture
        DetectionStrategy(
            strategy_id="t1056-azure",
            name="Azure Input Capture Detection",
            description=(
                "Azure detection for Input Capture. "
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Input Capture Detected",
                alert_description_template=(
                    "Input Capture activity detected. "
            ...
            detection_coverage="30% - only monitors Azure cloud operations, cannot detect endpoint keylogging",
