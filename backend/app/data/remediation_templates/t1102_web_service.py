...
resource "aws_sqs_queue" "dlq" {
  name                      = "guardduty-c2-web-service-dlq"
  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Web Service
        DetectionStrategy(
            strategy_id="t1102-azure",
            name="Azure Web Service Detection",
            description=(
                "Azure detection for Web Service. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Web Service
// MITRE ATT&CK: T1102
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Web Service
# MITRE ATT&CK: T1102
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Web Service
// MITRE ATT&CK: T1102
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Web Service (T1102) activity in Azure environment"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Web Service Detected",
                alert_description_template=(
                    "Web Service activity detected. "
