...
resource "aws_sns_topic_policy" "ssm_document_alerts" {
  arn = aws_sns_topic.ssm_document_alerts.arn
  policy = jsonencode({
    Version = "2012-10-17"
    Statement = [{
      Sid       = "AllowCloudWatchAlarms"
      ...
      Principal = { Service = "cloudwatch.amazonaws.com" }
      Action    = "sns:Publish"
      Resource  = aws_sns_topic.ssm_document_alerts.arn
      Condition = {
        StringEquals = {
          "AWS:SourceAccount" = data.aws_caller_identity.current.account_id
        }
  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Software Deployment Tools
        DetectionStrategy(
            strategy_id="t1072-azure",
            name="Azure Software Deployment Tools Detection",
            description=(
                "Azure detection for Software Deployment Tools. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Software Deployment Tools
// MITRE ATT&CK: T1072
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Software Deployment Tools
# MITRE ATT&CK: T1072
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "software-deployment-tools-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "software-deployment-tools-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Software Deployment Tools
// MITRE ATT&CK: T1072
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Software Deployment Tools (T1072) activity in Azure environment"
  display_name = "Software Deployment Tools Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1072"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Software Deployment Tools Detected",
                alert_description_template=(
                    "Software Deployment Tools activity detected. "
