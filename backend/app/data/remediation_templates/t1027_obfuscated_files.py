...
data "aws_iam_policy_document" "eventbridge_dlq_policy_lambda" {
  statement {
    ...
    condition {
      test     = "ArnEquals"
      variable = "aws:SourceArn"
      values   = [aws_cloudwatch_event_rule.lambda_updates.arn]
    }
  }
}
  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Condition = {
        ...
        # Azure Strategy: Obfuscated Files or Information
        DetectionStrategy(
            strategy_id="t1027-azure",
            name="Azure Obfuscated Files or Information Detection",
            description=(
                "Azure detection for Obfuscated Files or Information. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Obfuscated Files or Information
// MITRE ATT&CK: T1027
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Obfuscated Files or Information
# MITRE ATT&CK: T1027
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "obfuscated-files-or-information-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "obfuscated-files-or-information-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Obfuscated Files or Information
// MITRE ATT&CK: T1027
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Obfuscated Files or Information (T1027) activity in Azure environment"
  display_name = "Obfuscated Files or Information Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Obfuscated Files or Information Detected",
                alert_description_template=(
                    "Obfuscated Files or Information activity detected. "
