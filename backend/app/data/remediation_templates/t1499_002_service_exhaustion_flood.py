  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Endpoint Denial of Service: Service Exhaustion Flood
        DetectionStrategy(
            strategy_id="t1499002-azure",
            name="Azure Endpoint Denial of Service: Service Exhaustion Flood Detection",
            description=(
                "Azure detection for Endpoint Denial of Service: Service Exhaustion Flood. "
...
# Microsoft Defender detects Endpoint Denial of Service: Service Exhaustion Flood activity
...
resource "azurerm_monitor_action_group" "defender_alerts" {
  name                = "defender-t1499-002-alerts"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Endpoint Denial of Service: Service Exhaustion Flood Detected",
                alert_description_template=(
                    "Endpoint Denial of Service: Service Exhaustion Flood activity detected. "
