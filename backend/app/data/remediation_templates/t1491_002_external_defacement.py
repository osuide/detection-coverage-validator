...
data "aws_iam_policy_document" "eventbridge_dlq_policy" {
  statement {
    ...
    condition {
      ...
      values   = [aws_cloudwatch_event_rule.s3_content_modification.arn]
    }
  }
}
  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Condition = {
        ...
        ArnEquals = {
          "aws:SourceArn" = aws_cloudwatch_event_rule.s3_content_modification.arn
        }
      }
    }]
  })
...
resource "google_monitoring_alert_policy" "defacement_detection" {
  ...
  documentation {
    ...
    mime_type = "text/markdown"
        ...
        # Azure Strategy: Defacement: External Defacement
        DetectionStrategy(
            strategy_id="t1491002-azure",
            name="Azure Defacement: External Defacement Detection",
            description=(
                "Azure detection for Defacement: External Defacement. "
...
resource "azurerm_monitor_action_group" "defender_alerts" {
  name                = "defender-t1491-002-alerts"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Defacement: External Defacement Detected",
                alert_description_template=(
                    "Defacement: External Defacement activity detected. "
