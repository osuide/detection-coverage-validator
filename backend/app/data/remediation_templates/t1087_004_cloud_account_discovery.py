  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Account Discovery: Cloud Account
        DetectionStrategy(
            strategy_id="t1087004-azure",
            name="Azure Account Discovery: Cloud Account Detection",
            description=(
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Account Discovery: Cloud Account Detection
// Technique: T1087.004
AzureActivity
| where TimeGenerated > ago(24h)
| where OperationNameValue contains "Microsoft.Graph/servicePrincipals/" or OperationNameValue contains "Microsoft.ManagedIdentity/"
...
| order by TimeGenerated desc""",
                ...
                azure_terraform_template="""# Azure Detection for Account Discovery: Cloud Account
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "account-discovery--cloud-account-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "account-discovery--cloud-account-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Account Discovery: Cloud Account Detection
// Technique: T1087.004
AzureActivity
| where TimeGenerated > ago(24h)
| where OperationNameValue contains "Microsoft.Graph/servicePrincipals/" or OperationNameValue contains "Microsoft.ManagedIdentity/"
...
| order by TimeGenerated desc
  ...
  description = "Detects Account Discovery: Cloud Account (T1087.004) activity in Azure environment"
  display_name = "Account Discovery: Cloud Account Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1087.004"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Account Discovery: Cloud Account Detected",
                alert_description_template=(
                    "Account Discovery: Cloud Account activity detected. "
