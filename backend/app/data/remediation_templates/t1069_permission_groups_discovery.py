  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Condition = {
        ...
        # Azure Strategy: Permission Groups Discovery
        DetectionStrategy(
            strategy_id="t1069-azure",
            name="Azure Permission Groups Discovery Detection",
            description=(
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Permission Groups Discovery Detection
// Technique: T1069
AzureActivity
| where TimeGenerated > ago(24h)
| where OperationNameValue contains "Microsoft.Graph/groups/" or OperationNameValue contains "Microsoft.Authorization/"
...
| order by TimeGenerated desc""",
                ...
                azure_terraform_template="""# Azure Detection for Permission Groups Discovery
# MITRE ATT&CK: T1069
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "permission-groups-discovery-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "permission-groups-discovery-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Permission Groups Discovery Detection
// Technique: T1069
AzureActivity
| where TimeGenerated > ago(24h)
| where OperationNameValue contains "Microsoft.Graph/groups/" or OperationNameValue contains "Microsoft.Authorization/"
...
| order by TimeGenerated desc
  ...
  description = "Detects Permission Groups Discovery (T1069) activity in Azure environment"
  display_name = "Permission Groups Discovery Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1069"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Permission Groups Discovery Detected",
                alert_description_template=(
                    "Permission Groups Discovery activity detected. "
