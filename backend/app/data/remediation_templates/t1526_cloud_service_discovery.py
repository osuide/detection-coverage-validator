    ...
    Statement = [{
      ...
      Condition = {
        ...
        ArnEquals    = { "aws:SourceArn" = aws_cloudwatch_event_rule.guardduty.arn }
            ...
            evasion_considerations="Slow enumeration over days, using legitimate automation tools, staying within normal API call volumes",
  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Cloud Service Discovery
        DetectionStrategy(
            strategy_id="t1526-azure",
            name="Azure Cloud Service Discovery Detection",
            description=(
                "Azure detection for Cloud Service Discovery. "
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "cloud-service-discovery-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  ...
  criteria {
    query = <<-QUERY
// Cloud Service Discovery Detection
// Technique: T1526
AzureActivity
| where TimeGenerated > ago(24h)
...
| order by OperationCount desc
  ...
  description = "Detects Cloud Service Discovery (T1526) activity in Azure environment"
  display_name = "Cloud Service Discovery Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Cloud Service Discovery Detected",
                alert_description_template=(
                    "Cloud Service Discovery activity detected. "
