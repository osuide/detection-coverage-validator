  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Fallback Channels
        DetectionStrategy(
            strategy_id="t1008-azure",
            name="Azure Fallback Channels Detection",
            description=(
                "Azure detection for Fallback Channels. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Fallback Channels
// MITRE ATT&CK: T1008
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Fallback Channels
# MITRE ATT&CK: T1008
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "fallback-channels-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Fallback Channels
// MITRE ATT&CK: T1008
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Fallback Channels (T1008) activity in Azure environment"
  display_name = "Fallback Channels Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1008"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Fallback Channels Detected",
                alert_description_template=(
                    "Fallback Channels activity detected. "
