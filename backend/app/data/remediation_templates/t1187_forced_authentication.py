...
data "aws_iam_policy_document" "eventbridge_dlq_policy" {
  statement {
    ...
    condition {
      ...
      values   = [aws_cloudwatch_event_rule.network_findings.arn]
    }
  }
}
  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Forced Authentication
        DetectionStrategy(
            strategy_id="t1187-azure",
            name="Azure Forced Authentication Detection",
            description=(
                "Azure detection for Forced Authentication. "
...
# Microsoft Defender detects Forced Authentication activity
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Forced Authentication Detected",
                alert_description_template=(
                    "Forced Authentication activity detected. "
