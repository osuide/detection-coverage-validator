...
# Use in combination with endpoint USB detection for correlation.""",
        ...
        # Azure Strategy: Replication Through Removable Media
        DetectionStrategy(
            strategy_id="t1091-azure",
            name="Azure Replication Through Removable Media Detection",
            description=(
                "Azure detection for Replication Through Removable Media. "
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Replication Through Removable Media Detected",
                alert_description_template=(
                    "Replication Through Removable Media activity detected. "
            ...
            detection_coverage="30% - only monitors Azure cloud operations, cannot detect USB device connections",
