  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Modify Cloud Compute Infrastructure: Delete Cloud Instance
        DetectionStrategy(
            strategy_id="t1578003-azure",
            name="Azure Modify Cloud Compute Infrastructure: Delete Cloud Instance Detection",
            description=(
                "Azure detection for Modify Cloud Compute Infrastructure: Delete Cloud Instance. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Modify Cloud Compute Infrastructure: Delete Cloud Instance
// MITRE ATT&CK: T1578.003
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Modify Cloud Compute Infrastructure: Delete Cloud Instance
# MITRE ATT&CK: T1578.003
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "modify-cloud-compute-infrastructure--delete-cloud--alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "modify-cloud-compute-infrastructure--delete-cloud--detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Modify Cloud Compute Infrastructure: Delete Cloud Instance
// MITRE ATT&CK: T1578.003
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Modify Cloud Compute Infrastructure: Delete Cloud Instance (T1578.003) activity in Azure environment"
  display_name = "Modify Cloud Compute Infrastructure: Delete Cloud Instance Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1578.003"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Modify Cloud Compute Infrastructure: Delete Cloud Instance Detected",
                alert_description_template=(
                    "Modify Cloud Compute Infrastructure: Delete Cloud Instance activity detected. "
