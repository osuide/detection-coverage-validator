...
resource "aws_cloudwatch_metric_alarm" "process_enum" {
  ...
  alarm_actions       = [aws_sns_topic.alerts.arn]
            ...
            detection_coverage="75% - detects SSM-based enumeration",
...
resource "aws_cloudwatch_metric_alarm" "container_enum" {
  ...
  alarm_actions       = [aws_sns_topic.alerts.arn]
            ...
            detection_coverage="85% - detects ECS ExecuteCommand enumeration",
...
resource "google_monitoring_alert_policy" "process_enum" {
  ...
  notification_channels = [google_monitoring_notification_channel.email.id]
            ...
            detection_coverage="70% - detects logged command execution",
...
resource "google_monitoring_alert_policy" "gke_process_enum" {
  ...
  notification_channels = [google_monitoring_notification_channel.email.id]
            ...
            detection_coverage="80% - detects kubectl exec enumeration",
