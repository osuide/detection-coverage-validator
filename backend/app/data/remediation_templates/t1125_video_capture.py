  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Resource  = aws_sns_topic.alerts.arn
            ...
            detection_coverage="70% - catches video file uploads to cloud storage",
...
resource "aws_cloudwatch_metric_alarm" "recording_abuse" {
  ...
  alarm_actions       = [aws_sns_topic.alerts.arn]
            ...
            detection_coverage="65% - covers AWS Chime SDK, may miss third-party platform abuse",
...
resource "google_monitoring_alert_policy" "camera_access" {
  ...
  documentation {
    ...
    mime_type = "text/markdown"
            ...
            detection_coverage="75% - detects camera device access on Linux instances",
...
resource "google_monitoring_alert_policy" "video_uploads" {
  ...
  documentation {
    ...
    mime_type = "text/markdown"
            ...
            detection_coverage="80% - catches video file uploads to Cloud Storage",
