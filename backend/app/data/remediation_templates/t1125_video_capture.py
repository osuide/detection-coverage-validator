...
resource "google_monitoring_alert_policy" "video_uploads" {
  ...
  documentation {
    ...
    mime_type = "text/markdown"
        ...
        # Azure Strategy: Video Capture
        DetectionStrategy(
            strategy_id="t1125-azure",
            name="Azure Video Capture Detection",
            description=(
                "Azure detection for Video Capture. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Video Capture Detection
// Technique: T1125
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Video Capture
# MITRE ATT&CK: T1125
...
| order by OperationCount desc
  ...
  description = "Detects Video Capture (T1125) activity in Azure environment"
  display_name = "Video Capture Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1125"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Video Capture Detected",
                alert_description_template=(
                    "Video Capture activity detected. "
            ...
            detection_coverage="30% - only monitors Azure cloud operations, cannot detect endpoint camera access",
