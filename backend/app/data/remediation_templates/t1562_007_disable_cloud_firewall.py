...
resource "aws_cloudwatch_metric_alarm" "guardduty_suppression_alert" {
  ...
  alarm_actions       = [aws_sns_topic.guardduty_alerts.arn]
        ...
        # Azure Strategy: Impair Defenses: Disable or Modify Cloud Firewall
        DetectionStrategy(
            strategy_id="t1562007-azure",
            name="Azure Impair Defenses: Disable or Modify Cloud Firewall Detection",
            description=(
                "Azure detection for Impair Defenses: Disable or Modify Cloud Firewall. "
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "impair-defenses--disable-or-modify-cloud-firewall-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "impair-defenses--disable-or-modify-cloud-firewall-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Impair Defenses: Disable or Modify Cloud Firewall
// MITRE ATT&CK: T1562.007
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Impair Defenses: Disable or Modify Cloud Firewall (T1562.007) activity in Azure environment"
  display_name = "Impair Defenses: Disable or Modify Cloud Firewall Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Impair Defenses: Disable or Modify Cloud Firewall Detected",
                alert_description_template=(
                    "Impair Defenses: Disable or Modify Cloud Firewall activity detected. "
