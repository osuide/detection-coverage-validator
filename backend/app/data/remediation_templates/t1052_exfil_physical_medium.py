...
resource "aws_sqs_queue" "dlq" {
  name                      = "exfil-physical-medium-dlq"
...
data "aws_iam_policy_document" "eventbridge_dlq_policy" {
  statement {
    ...
    condition {
      ...
      values   = [aws_cloudwatch_event_rule.exfiltration_findings.arn]
    }
  }
}
...
# This detection only works with OS logs forwarded to Cloud Logging.""",
        ...
        # Azure Strategy: Exfiltration Over Physical Medium
        DetectionStrategy(
            strategy_id="t1052-azure",
            name="Azure Exfiltration Over Physical Medium Detection",
            description=(
                "Azure detection for Exfiltration Over Physical Medium. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Exfiltration Over Physical Medium Detection
// Technique: T1052
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Exfiltration Over Physical Medium
# MITRE ATT&CK: T1052
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  ...
  criteria {
    query = <<-QUERY
// Exfiltration Over Physical Medium Detection
// Technique: T1052
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects Exfiltration Over Physical Medium (T1052) activity in Azure environment"
  display_name = "Exfiltration Over Physical Medium Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1052"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Exfiltration Over Physical Medium Detected",
                alert_description_template=(
                    "Exfiltration Over Physical Medium activity detected. "
            ...
            detection_coverage="30% - only monitors Azure cloud operations, cannot detect physical data exfiltration",
