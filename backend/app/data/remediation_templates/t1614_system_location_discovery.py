  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: System Location Discovery
        DetectionStrategy(
            strategy_id="t1614-azure",
            name="Azure System Location Discovery Detection",
            description=(
                "Azure detection for System Location Discovery. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// System Location Discovery Detection
// Technique: T1614
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for System Location Discovery
# MITRE ATT&CK: T1614
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "system-location-discovery-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// System Location Discovery Detection
// Technique: T1614
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects System Location Discovery (T1614) activity in Azure environment"
  display_name = "System Location Discovery Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1614"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: System Location Discovery Detected",
                alert_description_template=(
                    "System Location Discovery activity detected. "
