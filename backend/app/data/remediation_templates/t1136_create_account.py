...
resource "aws_cloudwatch_metric_alarm" "rapid_creation" {
  ...
  alarm_actions       = [aws_sns_topic.alerts.arn]
        ...
        # Azure Strategy: Create Account
        DetectionStrategy(
            strategy_id="t1136-azure",
            name="Azure Create Account Detection",
            description=(
                "Monitor account and resource creation. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Create Account Detection
// Technique: T1136
AzureActivity
| where TimeGenerated > ago(24h)
| where OperationNameValue contains "Microsoft.Authorization/roleAssignments/write" or OperationNameValue contains "Microsoft.Compute/"
...
| order by TimeGenerated desc""",
                ...
                azure_terraform_template="""# Azure Detection for Create Account
# MITRE ATT&CK: T1136
...
| order by TimeGenerated desc
  ...
  description = "Detects Create Account (T1136) activity in Azure environment"
  display_name = "Create Account Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Create Account Detected",
                alert_description_template=(
                    "Create Account activity detected. "
