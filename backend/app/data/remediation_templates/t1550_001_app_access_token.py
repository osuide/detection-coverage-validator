  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Use Alternate Authentication Material: Application Access Token
        DetectionStrategy(
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Use Alternate Authentication Material: Application Access Token
# MITRE ATT&CK: T1550.001
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "use-alternate-authentication-material--application-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "use-alternate-authentication-material--application-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Use Alternate Authentication Material: Application Access Token
// MITRE ATT&CK: T1550.001
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Use Alternate Authentication Material: Application Access Token (T1550.001) activity in Azure environment"
  display_name = "Use Alternate Authentication Material: Application Access Token Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Use Alternate Authentication Material: Application Access Token Detected",
                alert_description_template=(
                    "Use Alternate Authentication Material: Application Access Token activity detected. "
