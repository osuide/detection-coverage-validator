  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Data Obfuscation
        DetectionStrategy(
            strategy_id="t1001-azure",
            name="Azure Data Obfuscation Detection",
            description=(
                "Azure detection for Data Obfuscation. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Data Obfuscation
// MITRE ATT&CK: T1001
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Data Obfuscation
# MITRE ATT&CK: T1001
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "data-obfuscation-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Data Obfuscation
// MITRE ATT&CK: T1001
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Data Obfuscation (T1001) activity in Azure environment"
  display_name = "Data Obfuscation Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1001"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Data Obfuscation Detected",
                alert_description_template=(
                    "Data Obfuscation activity detected. "
