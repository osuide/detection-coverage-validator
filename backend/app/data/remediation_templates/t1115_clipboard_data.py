...
resource "google_monitoring_alert_policy" "container_clipboard" {
  ...
  documentation {
    content = "Clipboard utility detected in GKE container - highly suspicious (T1115)"
        ...
        # Azure Strategy: Clipboard Data
        DetectionStrategy(
            strategy_id="t1115-azure",
            name="Azure Clipboard Data Detection",
            description=(
                "Azure detection for Clipboard Data. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Clipboard Data Detection
// Technique: T1115
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Clipboard Data
# MITRE ATT&CK: T1115
...
| order by OperationCount desc
  ...
  description = "Detects Clipboard Data (T1115) activity in Azure environment"
  display_name = "Clipboard Data Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1115"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Clipboard Data Detected",
                alert_description_template=(
                    "Clipboard Data activity detected. "
            ...
            detection_coverage="30% - only monitors Azure cloud operations, cannot detect endpoint clipboard access",
