...
resource "google_monitoring_alert_policy" "policy_alert" {
  ...
  documentation {
    ...
    mime_type = "text/markdown"
        ...
        # Azure Strategy: Software Extensions
        DetectionStrategy(
            strategy_id="t1176-azure",
            name="Azure Software Extensions Detection",
            description=(
                "Azure detection for Software Extensions. "
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Software Extensions Detected",
                alert_description_template=(
                    "Software Extensions activity detected. "
