...
resource "aws_sqs_queue" "dlq" {
  name                      = "guardduty-dns-c2-eventbridge-dlq"
...
output "scc_subscription" {
  ...
  value       = google_pubsub_subscription.scc_dns_findings.id
        ...
        # Azure Strategy: Application Layer Protocol: DNS
        DetectionStrategy(
            strategy_id="t1071004-azure",
            name="Azure Application Layer Protocol: DNS Detection",
            description=(
                "Azure detection for Application Layer Protocol: DNS. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Application Layer Protocol: DNS
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Application Layer Protocol: DNS
# MITRE ATT&CK: T1071.004
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "application-layer-protocol--dns-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "application-layer-protocol--dns-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Application Layer Protocol: DNS
// MITRE ATT&CK: T1071.004
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Application Layer Protocol: DNS (T1071.004) activity in Azure environment"
  display_name = "Application Layer Protocol: DNS Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Application Layer Protocol: DNS Detected",
                alert_description_template=(
                    "Application Layer Protocol: DNS activity detected. "
