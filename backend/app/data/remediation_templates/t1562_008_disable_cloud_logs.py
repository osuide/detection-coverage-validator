...
output "scp_policy_id" {
  ...
  description = "SCP policy ID for logging protection"
        ...
        # Azure Strategy: Impair Defences: Disable or Modify Cloud Logs
        DetectionStrategy(
            strategy_id="t1562008-azure",
            name="Azure Impair Defences: Disable or Modify Cloud Logs Detection",
            description=(
                "Azure detection for Impair Defences: Disable or Modify Cloud Logs. "
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Impair Defences: Disable or Modify Cloud Logs
// MITRE ATT&CK: T1562.008
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Impair Defences: Disable or Modify Cloud Logs (T1562.008) activity in Azure environment"
  display_name = "Impair Defences: Disable or Modify Cloud Logs Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Impair Defences: Disable or Modify Cloud Logs Detected",
                alert_description_template=(
                    "Impair Defences: Disable or Modify Cloud Logs activity detected. "
