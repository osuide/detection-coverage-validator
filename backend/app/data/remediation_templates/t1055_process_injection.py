...
output "alarm_name" {
  ...
  value       = aws_cloudwatch_metric_alarm.process_injection.alarm_name
            ...
            detection_coverage="60% - depends on audit log configuration. Primarily covers Linux syscall-based injection.",
...
output "alert_policy_id" {
  ...
  value       = google_monitoring_alert_policy.process_injection.id
            ...
            detection_coverage="60% - depends on OS-level audit logging configuration. Primarily Linux-focused.",
