  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Condition = {
        ...
        # Azure Strategy: Modify Registry
        DetectionStrategy(
            strategy_id="t1112-azure",
            name="Azure Modify Registry Detection",
            description=(
                "Azure detection for Modify Registry. "
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Modify Registry Detected",
                alert_description_template=(
                    "Modify Registry activity detected. "
