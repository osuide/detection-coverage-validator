...
output "rule_arn" {
  ...
  value       = aws_cloudwatch_event_rule.suspicious_api_pattern.arn
        ...
        # Azure Strategy: Native API
        DetectionStrategy(
            strategy_id="t1106-azure",
            name="Azure Native API Detection",
            description=(
                "Azure detection for Native API. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Native API
// MITRE ATT&CK: T1106
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Native API
# MITRE ATT&CK: T1106
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Native API
// MITRE ATT&CK: T1106
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Native API (T1106) activity in Azure environment"
  display_name = "Native API Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1106"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Native API Detected",
                alert_description_template=(
                    "Native API activity detected. "
