...
resource "google_monitoring_alert_policy" "excessive_vm_log_access" {
  ...
  documentation {
    ...
    mime_type = "text/markdown"
        ...
        # Azure Strategy: Log Enumeration
        DetectionStrategy(
            strategy_id="t1654-azure",
            name="Azure Log Enumeration Detection",
            description=(
                "Azure detection for Log Enumeration. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Log Enumeration Detection
// Technique: T1654
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Log Enumeration
# MITRE ATT&CK: T1654
...
| order by OperationCount desc
  ...
  description = "Detects Log Enumeration (T1654) activity in Azure environment"
  display_name = "Log Enumeration Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1654"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Log Enumeration Detected",
                alert_description_template=(
                    "Log Enumeration activity detected. "
