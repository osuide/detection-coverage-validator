...
resource "google_monitoring_alert_policy" "connectivity_discovery" {
  ...
  documentation {
    content = "Network connectivity configuration discovery detected. Review for authorised scanning."
        ...
        # Azure Strategy: System Network Configuration Discovery
        DetectionStrategy(
            strategy_id="t1016-azure",
            name="Azure System Network Configuration Discovery Detection",
            description=(
                "Azure detection for System Network Configuration Discovery. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// System Network Configuration Discovery Detection
// Technique: T1016
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for System Network Configuration Discovery
# MITRE ATT&CK: T1016
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "system-network-configuration-discovery-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "system-network-configuration-discovery-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// System Network Configuration Discovery Detection
// Technique: T1016
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects System Network Configuration Discovery (T1016) activity in Azure environment"
  display_name = "System Network Configuration Discovery Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1016"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: System Network Configuration Discovery Detected",
                alert_description_template=(
                    "System Network Configuration Discovery activity detected. "
