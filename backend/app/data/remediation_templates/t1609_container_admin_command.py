  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Condition = {
        ...
        # Azure Strategy: Container Administration Command
        DetectionStrategy(
            strategy_id="t1609-azure",
            name="Azure Container Administration Command Detection",
            description=(
                "Azure detection for Container Administration Command. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Container Administration Command
// MITRE ATT&CK: T1609
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Container Administration Command
# MITRE ATT&CK: T1609
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "container-administration-command-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "container-administration-command-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Container Administration Command
// MITRE ATT&CK: T1609
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Container Administration Command (T1609) activity in Azure environment"
  display_name = "Container Administration Command Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Container Administration Command Detected",
                alert_description_template=(
                    "Container Administration Command activity detected. "
