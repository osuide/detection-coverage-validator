  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Protocol Tunneling
        DetectionStrategy(
            strategy_id="t1572-azure",
            name="Azure Protocol Tunneling Detection",
            description=(
                "Azure detection for Protocol Tunneling. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Protocol Tunneling
// MITRE ATT&CK: T1572
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Protocol Tunneling
# MITRE ATT&CK: T1572
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "protocol-tunneling-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "protocol-tunneling-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Protocol Tunneling
// MITRE ATT&CK: T1572
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Protocol Tunneling (T1572) activity in Azure environment"
  display_name = "Protocol Tunneling Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Protocol Tunneling Detected",
                alert_description_template=(
                    "Protocol Tunneling activity detected. "
