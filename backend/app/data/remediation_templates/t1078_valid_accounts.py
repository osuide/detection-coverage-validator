...
output "bigquery_dataset" {
  ...
  description = "BigQuery dataset for workload identity logs"
        ...
        # Azure Strategy: Valid Accounts
        DetectionStrategy(
            strategy_id="t1078-azure",
            name="Azure Valid Accounts Detection",
            description=(
                "Microsoft Defender for Identity and Entra ID Protection detect anomalous sign-ins. "
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Valid Accounts Detected",
                alert_description_template=(
                    "Valid Accounts activity detected. "
