        ...
        Statement:
          - Effect: Allow
            ...
            Condition:
              ...
              ArnEquals:
                aws:SourceArn: !GetAtt IPCFindingsRule.Arn
...
output "notification_config_id" {
  ...
  value       = google_scc_notification_config.ipc_abuse.config_id
        ...
        # Azure Strategy: Inter-Process Communication
        DetectionStrategy(
            strategy_id="t1559-azure",
            name="Azure Inter-Process Communication Detection",
            description=(
                "Azure detection for Inter-Process Communication. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Inter-Process Communication
// MITRE ATT&CK: T1559
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Inter-Process Communication
# MITRE ATT&CK: T1559
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "inter-process-communication-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "inter-process-communication-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Inter-Process Communication
// MITRE ATT&CK: T1559
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Inter-Process Communication (T1559) activity in Azure environment"
  display_name = "Inter-Process Communication Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Inter-Process Communication Detected",
                alert_description_template=(
                    "Inter-Process Communication activity detected. "
