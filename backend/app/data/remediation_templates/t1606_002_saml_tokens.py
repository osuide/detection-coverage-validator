...
resource "aws_cloudwatch_metric_alarm" "cross_account_saml" {
  ...
  alarm_actions       = [aws_sns_topic.cross_account_alerts.arn]
        ...
        # Azure Strategy: Forge Web Credentials: SAML Tokens
        DetectionStrategy(
            strategy_id="t1606002-azure",
            name="Azure Forge Web Credentials: SAML Tokens Detection",
            description=(
                "Azure detection for Forge Web Credentials: SAML Tokens. "
...
resource "azurerm_monitor_action_group" "defender_alerts" {
  name                = "defender-t1606-002-alerts"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Forge Web Credentials: SAML Tokens Detected",
                alert_description_template=(
                    "Forge Web Credentials: SAML Tokens activity detected. "
