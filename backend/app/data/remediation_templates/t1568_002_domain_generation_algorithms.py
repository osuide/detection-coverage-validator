  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Dynamic Resolution: Domain Generation Algorithms
        DetectionStrategy(
            strategy_id="t1568002-azure",
            name="Azure Dynamic Resolution: Domain Generation Algorithms Detection",
            description=(
                "Azure detection for Dynamic Resolution: Domain Generation Algorithms. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Dynamic Resolution: Domain Generation Algorithms
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Dynamic Resolution: Domain Generation Algorithms
# MITRE ATT&CK: T1568.002
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "dynamic-resolution--domain-generation-algorithms-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "dynamic-resolution--domain-generation-algorithms-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Dynamic Resolution: Domain Generation Algorithms
// MITRE ATT&CK: T1568.002
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Dynamic Resolution: Domain Generation Algorithms (T1568.002) activity in Azure environment"
  display_name = "Dynamic Resolution: Domain Generation Algorithms Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1568.002"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Dynamic Resolution: Domain Generation Algorithms Detected",
                alert_description_template=(
                    "Dynamic Resolution: Domain Generation Algorithms activity detected. "
