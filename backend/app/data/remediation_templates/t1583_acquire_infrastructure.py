  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Acquire Infrastructure
        DetectionStrategy(
            strategy_id="t1583-azure",
            name="Azure Acquire Infrastructure Detection",
            description=(
                "Azure detection for Acquire Infrastructure. "
...
# Microsoft Defender detects Acquire Infrastructure activity
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Acquire Infrastructure Detected",
                alert_description_template=(
                    "Acquire Infrastructure activity detected. "
