...
# with file integrity monitoring configuration""",
        ...
        # Azure Strategy: Defacement: Internal Defacement
        DetectionStrategy(
            strategy_id="t1491001-azure",
            name="Azure Defacement: Internal Defacement Detection",
            description=(
                "Azure detection for Defacement: Internal Defacement. "
...
# Microsoft Defender detects Defacement: Internal Defacement activity
...
resource "azurerm_monitor_action_group" "defender_alerts" {
  name                = "defender-t1491-001-alerts"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Defacement: Internal Defacement Detected",
                alert_description_template=(
                    "Defacement: Internal Defacement activity detected. "
