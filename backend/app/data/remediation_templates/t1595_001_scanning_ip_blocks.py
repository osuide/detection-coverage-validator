...
resource "google_monitoring_alert_policy" "ids_alerts" {
  ...
  documentation {
    content = "Cloud IDS detected reconnaissance or scanning activity."
        ...
        # Azure Strategy: Active Scanning: Scanning IP Blocks
        DetectionStrategy(
            strategy_id="t1595001-azure",
            name="Azure Active Scanning: Scanning IP Blocks Detection",
            description=(
                "Azure detection for Active Scanning: Scanning IP Blocks. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Active Scanning: Scanning IP Blocks Detection
// Technique: T1595.001
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Active Scanning: Scanning IP Blocks
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "active-scanning--scanning-ip-blocks-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "active-scanning--scanning-ip-blocks-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Active Scanning: Scanning IP Blocks Detection
// Technique: T1595.001
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects Active Scanning: Scanning IP Blocks (T1595.001) activity in Azure environment"
  display_name = "Active Scanning: Scanning IP Blocks Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Active Scanning: Scanning IP Blocks Detected",
                alert_description_template=(
                    "Active Scanning: Scanning IP Blocks activity detected. "
