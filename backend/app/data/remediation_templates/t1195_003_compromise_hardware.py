...
resource "google_pubsub_topic_iam_binding" "log_sink" {
  ...
  members = [google_logging_project_sink.instance_creation.writer_identity]
        ...
        # Azure Strategy: Supply Chain Compromise: Compromise Hardware Supply Chain
        DetectionStrategy(
            strategy_id="t1195003-azure",
            name="Azure Supply Chain Compromise: Compromise Hardware Supply Chain Detection",
            description=(
                "Azure detection for Supply Chain Compromise: Compromise Hardware Supply Chain. "
...
resource "azurerm_monitor_action_group" "defender_alerts" {
  name                = "defender-t1195-003-alerts"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Supply Chain Compromise: Compromise Hardware Supply Chain Detected",
                alert_description_template=(
                    "Supply Chain Compromise: Compromise Hardware Supply Chain activity detected. "
