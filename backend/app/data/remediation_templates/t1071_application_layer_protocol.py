        ...
        Statement:
          - Effect: Allow
            ...
            Condition:
              ...
              ArnEquals:
                aws:SourceArn: !GetAtt DnsQueryRule.Arn""",
  ...
  policy = jsonencode({
    ...
    Condition = {
        StringEquals = {
          ...
          ArnEquals = {
            "aws:SourceArn" = aws_cloudwatch_event_rule.dns_anomaly.arn
          }
      }
    }]
  })
...
resource "aws_cloudwatch_metric_alarm" "protocol_anomaly" {
  ...
  alarm_actions       = [aws_sns_topic.protocol_alerts.arn]
        ...
        # Azure Strategy: Application Layer Protocol
        DetectionStrategy(
            strategy_id="t1071-azure",
            name="Azure Application Layer Protocol Detection",
            description=(
                "Azure detection for Application Layer Protocol. "
            ...
            implementation=DetectionImplementation(
                sentinel_rule_query="""// Sentinel Analytics Rule: Application Layer Protocol
// MITRE ATT&CK: T1071
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
    ...
    Operations,
    Resources""",
                azure_terraform_template="""# Azure Detection for Application Layer Protocol
# MITRE ATT&CK: T1071
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "application-layer-protocol-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "application-layer-protocol-detection"
  resource_group_name = var.resource_group_name
  ...
  criteria {
    query = <<-QUERY
// Sentinel Analytics Rule: Application Layer Protocol
// MITRE ATT&CK: T1071
let lookback = 24h;
let threshold = 5;
AzureActivity
...
| project
  ...
  description = "Detects Application Layer Protocol (T1071) activity in Azure environment"
  display_name = "Application Layer Protocol Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Application Layer Protocol Detected",
                alert_description_template=(
                    "Application Layer Protocol activity detected. "
