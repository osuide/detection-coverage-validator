  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Data Encrypted for Impact
        DetectionStrategy(
            strategy_id="t1486-azure",
            name="Azure Data Encrypted for Impact Detection",
            description=(
                "Defender detects ransomware and encryption attacks. "
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Data Encrypted for Impact Detected",
                alert_description_template=(
                    "Data Encrypted for Impact activity detected. "
