...
resource "google_monitoring_alert_policy" "ad_modification" {
  ...
  documentation {
    ...
    mime_type = "text/markdown"
        ...
        # Azure Strategy: Adversary-in-the-Middle: LLMNR/NBT-NS Poisoning and SMB Relay
        DetectionStrategy(
            strategy_id="t1557001-azure",
            name="Azure Adversary-in-the-Middle: LLMNR/NBT-NS Poisoning and SMB Relay Detection",
            description=(
                "Azure detection for Adversary-in-the-Middle: LLMNR/NBT-NS Poisoning and SMB Relay. "
...
resource "azurerm_monitor_action_group" "defender_alerts" {
  name                = "defender-t1557-001-alerts"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Adversary-in-the-Middle: LLMNR/NBT-NS Poisoning and SMB Relay Detected",
                alert_description_template=(
                    "Adversary-in-the-Middle: LLMNR/NBT-NS Poisoning and SMB Relay activity detected. "
