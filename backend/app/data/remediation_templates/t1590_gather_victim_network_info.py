  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Gather Victim Network Information
        DetectionStrategy(
            strategy_id="t1590-azure",
            name="Azure Gather Victim Network Information Detection",
            description=(
                "Azure detection for Gather Victim Network Information. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Gather Victim Network Information Detection
// Technique: T1590
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Gather Victim Network Information
# MITRE ATT&CK: T1590
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "gather-victim-network-information-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "gather-victim-network-information-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Gather Victim Network Information Detection
// Technique: T1590
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects Gather Victim Network Information (T1590) activity in Azure environment"
  display_name = "Gather Victim Network Information Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1590"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Gather Victim Network Information Detected",
                alert_description_template=(
                    "Gather Victim Network Information activity detected. "
