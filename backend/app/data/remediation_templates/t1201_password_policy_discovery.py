  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: Password Policy Discovery
        DetectionStrategy(
            strategy_id="t1201-azure",
            name="Azure Password Policy Discovery Detection",
            description=(
                "Azure detection for Password Policy Discovery. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Password Policy Discovery Detection
// Technique: T1201
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Password Policy Discovery
# MITRE ATT&CK: T1201
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  ...
  criteria {
    query = <<-QUERY
// Password Policy Discovery Detection
// Technique: T1201
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects Password Policy Discovery (T1201) activity in Azure environment"
  display_name = "Password Policy Discovery Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1201"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Password Policy Discovery Detected",
