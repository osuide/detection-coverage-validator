...
data "aws_iam_policy_document" "eventbridge_dlq_policy" {
  statement {
    ...
    condition {
      ...
      values   = [aws_cloudwatch_event_rule.brute_force.arn]
    }
  }
}
...
resource "google_monitoring_alert_policy" "ssh_brute_force" {
  ...
  documentation {
    ...
    mime_type = "text/markdown"
        ...
        # Azure Strategy: Brute Force
        DetectionStrategy(
            strategy_id="t1110-azure",
            name="Azure Brute Force Detection",
            description=(
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Brute Force Detected",
                alert_description_template=(
