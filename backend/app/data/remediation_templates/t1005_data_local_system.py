...
resource "google_monitoring_alert_policy" "file_access_alert" {
  ...
  documentation {
    content = "Multiple accesses to sensitive files detected on Compute instance. Investigate for potential credential theft or data collection."
        ...
        # Azure Strategy: Data from Local System
        DetectionStrategy(
            strategy_id="t1005-azure",
            name="Azure Data from Local System Detection",
            description=(
                "Azure detection for Data from Local System. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Data from Local System Detection
// Technique: T1005
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Data from Local System
# MITRE ATT&CK: T1005
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "data-from-local-system-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "data-from-local-system-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// Data from Local System Detection
// Technique: T1005
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects Data from Local System (T1005) activity in Azure environment"
  display_name = "Data from Local System Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Data from Local System Detected",
                alert_description_template=(
                    "Data from Local System activity detected. "
