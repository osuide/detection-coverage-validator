  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Condition = {
        ...
        # Azure Strategy: Email Bombing
        DetectionStrategy(
            strategy_id="t1667-azure",
            name="Azure Email Bombing Detection",
            description=(
                "Azure detection for Email Bombing. "
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Email Bombing Detected",
                alert_description_template=(
                    "Email Bombing activity detected. "
