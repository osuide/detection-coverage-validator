...
resource "google_storage_bucket_iam_member" "log_writer" {
  ...
  member = google_logging_project_sink.ad_auth_logs.writer_identity
        ...
        # Azure Strategy: Steal or Forge Kerberos Tickets
        DetectionStrategy(
            strategy_id="t1558-azure",
            name="Azure Steal or Forge Kerberos Tickets Detection",
            description=(
                "Azure detection for Steal or Forge Kerberos Tickets. "
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.defender_detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Steal or Forge Kerberos Tickets Detected",
                alert_description_template=(
                    "Steal or Forge Kerberos Tickets activity detected. "
