  ...
  alert_strategy {
    ...
    notification_rate_limit {
      period = "300s"
        ...
        # Azure Strategy: System Service Discovery
        DetectionStrategy(
            strategy_id="t1007-azure",
            name="Azure System Service Discovery Detection",
            description=(
                "Azure detection for System Service Discovery. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// System Service Discovery Detection
// Technique: T1007
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for System Service Discovery
# MITRE ATT&CK: T1007
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "system-service-discovery-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "system-service-discovery-detection"
  resource_group_name = var.resource_group_name
  location            = "uksouth"
  ...
  criteria {
    query = <<-QUERY
// System Service Discovery Detection
// Technique: T1007
AzureActivity
| where TimeGenerated > ago(24h)
| where CategoryValue == "Administrative"
...
| order by OperationCount desc
  ...
  description = "Detects System Service Discovery (T1007) activity in Azure environment"
  display_name = "System Service Discovery Detection"
  enabled      = true

  tags = {
    "mitre-technique" = "T1007"
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: System Service Discovery Detected",
                alert_description_template=(
                    "System Service Discovery activity detected. "
