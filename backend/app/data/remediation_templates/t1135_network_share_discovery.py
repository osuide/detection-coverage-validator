...
resource "aws_sns_topic_policy" "guardduty_alerts_policy" {
  ...
  policy = jsonencode({
    ...
    Condition = {
        ...
        # Azure Strategy: Network Share Discovery
        DetectionStrategy(
            strategy_id="t1135-azure",
            name="Azure Network Share Discovery Detection",
            description=(
                "Azure detection for Network Share Discovery. "
            ...
            implementation=DetectionImplementation(
                azure_kql_query="""// Network Share Discovery Detection
// Technique: T1135
AzureActivity
...
| order by OperationCount desc""",
                azure_terraform_template="""# Azure Detection for Network Share Discovery
# MITRE ATT&CK: T1135
...
resource "azurerm_monitor_action_group" "security_alerts" {
  name                = "network-share-discovery-alerts"
...
resource "azurerm_monitor_scheduled_query_rules_alert_v2" "detection" {
  name                = "network-share-discovery-detection"
  resource_group_name = var.resource_group_name
...
| order by OperationCount desc
  ...
  description = "Detects Network Share Discovery (T1135) activity in Azure environment"
  display_name = "Network Share Discovery Detection"
  enabled      = true
...
output "alert_rule_id" {
  value = azurerm_monitor_scheduled_query_rules_alert_v2.detection.id
                ...
                alert_severity="high",
                alert_title="Azure: Network Share Discovery Detected",
                alert_description_template=(
                    "Network Share Discovery activity detected. "
