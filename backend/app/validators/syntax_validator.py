...
class SyntaxValidator(BaseValidator):
    ...
    async def validate(
        ...
        elif detection_type in [DetectionType.GUARDDUTY_FINDING, DetectionType.GCP_SECURITY_COMMAND_CENTER]:
        ...
        result.metadata = {
            "detection_type": detection_type.value if hasattr(detection_type, 'value') else str(detection_type),
    ...
    def _validate_cloudwatch_query(
        ...
        valid_commands = ["fields", "filter", "stats", "sort", "limit", "parse", "display"]
    ...
    def _validate_event_pattern(
        ...
        if not event_pattern:
            ...
            event_pattern = raw_config.get("eventPattern") or raw_config.get("event_pattern")
        ...
        valid_keys = {
            "source", "detail-type", "detail", "account", "region",
            "resources", "time", "id", "version",
        }
