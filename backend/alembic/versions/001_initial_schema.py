...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "provider", sa.Enum("aws", "gcp", name="cloudprovider"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("active", "disabled", "error", "unknown", name="detectionstatus"),
            default="unknown",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "mapping_source",
            sa.Enum("pattern_match", "nlp", "manual", "vendor", name="mappingsource"),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_detection_mappings_detection_id", "detection_mappings", ["detection_id"]
    )
    op.create_index(
        "ix_detection_mappings_technique_id", "detection_mappings", ["technique_id"]
    )
    ...
    op.create_index(
        "ix_coverage_snapshots_cloud_account_id",
        "coverage_snapshots",
        ["cloud_account_id"],
    )
    op.create_index(
        "ix_coverage_snapshots_created_at", "coverage_snapshots", ["created_at"]
    )
