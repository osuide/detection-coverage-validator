...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        # Session Settings
        sa.Column('session_timeout_minutes', sa.Integer(), server_default='1440', nullable=False),  # 24 hours
        sa.Column('idle_timeout_minutes', sa.Integer(), server_default='60', nullable=False),
        # Auth Methods
        sa.Column('allowed_auth_methods', JSONB, server_default='["password"]', nullable=False),
        # Password Policy
        ...
        sa.Column('password_require_lowercase', sa.Boolean(), server_default='true', nullable=False),
        sa.Column('password_require_number', sa.Boolean(), server_default='true', nullable=False),
        sa.Column('password_require_special', sa.Boolean(), server_default='true', nullable=False),
        # Lockout Policy
        sa.Column('max_failed_login_attempts', sa.Integer(), server_default='5', nullable=False),
    ...
    op.create_index('idx_security_settings_org', 'organization_security_settings', ['organization_id'])
    ...
    op.create_table(
        ...
        sa.Column('verification_method', sa.String(50), nullable=True),  # dns_txt, dns_cname, meta_tag
        sa.Column('verified_at', sa.DateTime(timezone=True), nullable=True),
        sa.Column('auto_join_enabled', sa.Boolean(), server_default='false', nullable=False),
