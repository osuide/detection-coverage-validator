...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('cloud_account_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('cloud_accounts.id'), nullable=True),
        sa.Column('name', sa.String(255), nullable=False),
        sa.Column('description', sa.String(500), nullable=True),
        sa.Column('alert_type', postgresql.ENUM('coverage_threshold', 'gap_detected', 'scan_completed', 'scan_failed', 'stale_detection', 'new_technique', name='alerttype', create_type=False), nullable=False),
        sa.Column('severity', postgresql.ENUM('info', 'warning', 'critical', name='alertseverity', create_type=False), default='warning'),
    ...
    op.create_index('ix_alert_configs_cloud_account_id', 'alert_configs', ['cloud_account_id'])
    ...
    op.create_index('ix_alert_history_cloud_account_id', 'alert_history', ['cloud_account_id'])
